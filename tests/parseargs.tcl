...
test parseargs.196 {parseargs0 cget -abbreviations} {
    list [catch {parseargs0 cget -abbreviations} msg] $msg
} {0 0}

test parseargs.197 {parseargs0 cget -default} {
    list [catch {parseargs0 cget -default} msg] $msg
} {0 {}}

test parseargs.198 {parseargs0 cget -epilog} {
    list [catch {parseargs0 cget -epilog} msg] $msg
} {0 {}}

test parseargs.199 {parseargs0 cget -error} {
    list [catch {parseargs0 cget -error} msg] $msg
} {0 badoption}

test parseargs.200 {parseargs0 cget -prefixchars} {
    list [catch {parseargs0 cget -prefixchars} msg] $msg
} {0 -+}

test parseargs.201 {parseargs0 cget -program} {
    list [catch {parseargs0 cget -program} msg] $msg
} {0 {}}

test parseargs.202 {parseargs0 cget -usage} {
...
test parseargs.205 {parseargs0 configure -abbreviations} {
    list [catch {parseargs0 configure -abbreviations} msg] $msg
} {0 {-abbreviations 0 0}}

test parseargs.206 {parseargs0 configure -default} {
    list [catch {parseargs0 configure -default} msg] $msg
} {0 {-default {} {}}}

test parseargs.207 {parseargs0 configure -epilog} {
    list [catch {parseargs0 configure -epilog} msg] $msg
} {0 {-epilog {} {}}}

test parseargs.208 {parseargs0 configure -error} {
    list [catch {parseargs0 configure -error} msg] $msg
} {0 {-error badoption badoption}}

test parseargs.209 {parseargs0 configure -prefixchars} {
    list [catch {parseargs0 configure -prefixchars} msg] $msg
} {0 {-prefixchars -+ -+}}

test parseargs.210 {parseargs0 configure -program} {
    list [catch {parseargs0 configure -program} msg] $msg
} {0 {-program {} {}}}

test parseargs.211 {parseargs0 configure -usage} {
    list [catch {parseargs0 configure -usage} msg] $msg
} {0 {-usage {} {}}}

test parseargs.212 {parseargs0 configure -abbreviations badBool} {
    list [catch {parseargs0 configure -abbreviations badBool} msg] $msg
} {1 {expected boolean value but got "badBool"}}

test parseargs.213 {parseargs0 configure -abbreviations 1} {
    list [catch {parseargs0 configure -abbreviations 1} msg] $msg
} {0 {}}

test parseargs.214 {parseargs0 configure -abbreviations true} {
    list [catch {parseargs0 configure -abbreviations true} msg] $msg
} {0 {}}

test parseargs.215 {parseargs0 configure -abbreviations yes} {
    list [catch {parseargs0 configure -abbreviations yes} msg] $msg
} {0 {}}

test parseargs.216 {parseargs0 configure -abbreviations on} {
    list [catch {parseargs0 configure -abbreviations on} msg] $msg
} {0 {}}

test parseargs.217 {parseargs0 configure -abbreviations} {
    list [catch {parseargs0 configure -abbreviations} msg] $msg
} {0 {-abbreviations 0 1}}

test parseargs.218 {parseargs0 configure -abbreviations 0} {
    list [catch {parseargs0 configure -abbreviations 0} msg] $msg
} {0 {}}

test parseargs.219 {parseargs0 configure -abbreviations false} {
    list [catch {parseargs0 configure -abbreviations false} msg] $msg
} {0 {}}

test parseargs.220 {parseargs0 configure -abbreviations no} {
    list [catch {parseargs0 configure -abbreviations no} msg] $msg
} {0 {}}

test parseargs.221 {parseargs0 configure -abbreviations off} {
    list [catch {parseargs0 configure -abbreviations off} msg] $msg
} {0 {}}

test parseargs.222 {parseargs0 configure -abbreviations} {
    list [catch {parseargs0 configure -abbreviations} msg] $msg
} {0 {-abbreviations 0 0}}

test parseargs.223 {parseargs0 configure -default} {
    list [catch {parseargs0 configure -default} msg] $msg
} {0 {-default {} {}}}

test parseargs.224 {parseargs0 configure -default defValue} {
    list [catch {
	parseargs0 configure -default defValue
    } msg] $msg
} {0 {}}

test parseargs.225 {parseargs0 configure -default} {
    list [catch {parseargs0 configure -default} msg] $msg
} {0 {-default {} defValue}}

test parseargs.226 {parseargs0 configure -default ""} {
    list [catch {
	parseargs0 configure -default ""
    } msg] $msg
} {0 {}}

test parseargs.227 {parseargs0 configure -default} {
    list [catch {parseargs0 configure -default} msg] $msg
} {0 {-default {} {}}}

test parseargs.228 {parseargs0 configure -epilog} {
    list [catch {parseargs0 configure -epilog} msg] $msg
} {0 {-epilog {} {}}}

test parseargs.229 {parseargs0 configure -epilog defValue} {
    list [catch {
	parseargs0 configure -epilog defValue
    } msg] $msg
} {0 {}}

test parseargs.230 {parseargs0 configure -epilog} {
    list [catch {parseargs0 configure -epilog} msg] $msg
} {0 {-epilog {} defValue}}

test parseargs.231 {parseargs0 configure -epilog ""} {
    list [catch {
	parseargs0 configure -epilog ""
    } msg] $msg
} {0 {}}

test parseargs.232 {parseargs0 configure -epilog} {
    list [catch {parseargs0 configure -epilog} msg] $msg
} {0 {-epilog {} {}}}

test parseargs.233 {parseargs0 configure -error badFlag} {
    list [catch {parseargs0 configure -error badFlag} msg] $msg
} {1 {unknown error flag "badFlag": should be badoption or extraargs}}

test parseargs.234 {parseargs0 configure -error badoption} {
    list [catch {parseargs0 configure -error badoption} msg] $msg
} {0 {}}

test parseargs.235 {parseargs0 configure -error} {
    list [catch {parseargs0 configure -error} msg] $msg
} {0 {-error badoption badoption}}

test parseargs.236 {parseargs0 configure -error extraargs} {
    list [catch {parseargs0 configure -error extraargs} msg] $msg
} {0 {}}

test parseargs.237 {parseargs0 configure -error} {
    list [catch {parseargs0 configure -error} msg] $msg
} {0 {-error badoption extraargs}}

test parseargs.238 {parseargs0 configure -error "extraargs badoption badFlag"} {
    list [catch {
	parseargs0 configure -error "extraargs badoption badFlag"
    } msg] $msg
} {1 {unknown error flag "badFlag": should be badoption or extraargs}}

test parseargs.239 {parseargs0 configure -error} {
    list [catch {parseargs0 configure -error} msg] $msg
} {0 {-error badoption extraargs}}

test parseargs.240 {parseargs0 configure -error "extraargs badoption"} {
    list [catch {
	parseargs0 configure -error "extraargs badoption"
    } msg] $msg
} {0 {}}

test parseargs.241 {parseargs0 configure -prefixchars} {
    list [catch {parseargs0 configure -prefixchars} msg] $msg
} {0 {-prefixchars -+ -+}}

test parseargs.242 {parseargs0 configure -prefixchars ?} {
    list [catch {
	parseargs0 configure -prefixchars ?
    } msg] $msg
} {0 {}}

test parseargs.243 {parseargs0 configure -prefixchars} {
    list [catch {parseargs0 configure -prefixchars} msg] $msg
} {0 {-prefixchars -+ ?}}

test parseargs.244 {parseargs0 configure -prefixchars ""} {
    list [catch {
	parseargs0 configure -prefixchars ""
    } msg] $msg
} {0 {}}

test parseargs.245 {parseargs0 configure -prefixchars} {
    list [catch {parseargs0 configure -prefixchars} msg] $msg
} {0 {-prefixchars -+ {}}}

test parseargs.246 {parseargs0 configure -prefixchars "+-"} {
    list [catch {
	parseargs0 configure -prefixchars "+-"
    } msg] $msg
} {0 {}}

test parseargs.247 {parseargs0 configure -prefixchars} {
    list [catch {parseargs0 configure -prefixchars} msg] $msg
} {0 {-prefixchars -+ +-}}

test parseargs.248 {parseargs0 configure -program} {
    list [catch {parseargs0 configure -program} msg] $msg
} {0 {-program {} {}}}

test parseargs.249 {parseargs0 configure -program defValue} {
    list [catch {
	parseargs0 configure -program defValue
    } msg] $msg
} {0 {}}

test parseargs.250 {parseargs0 configure -program} {
    list [catch {parseargs0 configure -program} msg] $msg
} {0 {-program {} defValue}}

test parseargs.251 {parseargs0 configure -program ""} {
    list [catch {
	parseargs0 configure -program ""
    } msg] $msg
} {0 {}}

test parseargs.252 {parseargs0 configure -program} {
    list [catch {parseargs0 configure -program} msg] $msg
} {0 {-program {} {}}}

test parseargs.253 {parseargs0 configure -usage} {
    list [catch {parseargs0 configure -usage} msg] $msg
} {0 {-usage {} {}}}

test parseargs.254 {parseargs0 configure -usage defValue} {
    list [catch {
	parseargs0 configure -usage defValue
    } msg] $msg
} {0 {}}

test parseargs.255 {parseargs0 configure -usage} {
    list [catch {parseargs0 configure -usage} msg] $msg
} {0 {-usage {} defValue}}

test parseargs.256 {parseargs0 configure -usage ""} {
    list [catch {
	parseargs0 configure -usage ""
    } msg] $msg
} {0 {}}

test parseargs.257 {parseargs0 configure -usage} {
    list [catch {parseargs0 configure -usage} msg] $msg
} {0 {-usage {} {}}}


test parseargs.258 {parseargs destroy parseargs0} {
    list [catch {blt::parseargs destroy parseargs0} msg] $msg
} {0 {}}

test parseargs.259 {parseargs0} {
    list [catch {parseargs0} msg] $msg
} {1 {invalid command name "parseargs0"}}

test parseargs.260 {blt::parseargs create -badOption 0} {
...
test parseargs.261 {blt::parseargs create -default (missing arg)} {
    list [catch {blt::parseargs create -default} msg] $msg
} {1 {value for "-default" missing}}

test parseargs.262 {blt::parseargs create -abbreviations (missing arg)} {
    list [catch {blt::parseargs create -abbreviations} msg] $msg
} {1 {value for "-abbreviations" missing}}

test parseargs.263 {blt::parseargs names} {
    list [catch {blt::parseargs names} msg] $msg
} {0 {}}

test parseargs.264 {blt::parseargs create myParser} {
...
test parseargs.266 {myParser add test} {
...
test parseargs.284 {myParser configure -abbreviations 0} {
    list [catch { myParser configure -abbreviations 0 } msg] $msg
} {0 {}}

test parseargs.285 {myParser argument configure "verbose" -min 0 -max 10} {
    list [catch { 
	myParser argument configure "verbose" -min 0 -max 10 
    } msg] $msg
} {0 {}}

test parseargs.286 {myParser parse "--verbose 0"} {
    list [catch { myParser parse "--verbose 0" } msg] $msg
} {0 {}}

test parseargs.287 {myParser parse "--verbose 10"} {
    list [catch { myParser parse "--verbose 10" } msg] $msg
} {0 {}}

test parseargs.288 {myParser parse "--verbose 11"} {
...
test parseargs.290 {myParser parse "--debug 0"} {
    list [catch { myParser parse "--debug 0" } msg] $msg
} {0 {}}

test parseargs.291 {myParser parse "--debug true"} {
    list [catch { myParser parse "--debug true" } msg] $msg
} {0 {}}

test parseargs.292 {myParser parse "--debug yes"} {
    list [catch { myParser parse "--debug yes" } msg] $msg
} {0 {}}

test parseargs.293 {myParser parse "--debug on"} {
    list [catch { myParser parse "--debug on" } msg] $msg
} {0 {}}

test parseargs.294 {myParser parse "--debug false"} {
    list [catch { myParser parse "--debug true" } msg] $msg
} {0 {}}

test parseargs.295 {myParser parse "--debug no"} {
    list [catch { myParser parse "--debug no" } msg] $msg
} {0 {}}

test parseargs.296 {myParser parse "--debug off"} {
    list [catch { myParser parse "--debug off" } msg] $msg
} {0 {}}

test parseargs.297 {myParser parse "--debug 0"} {
    list [catch { myParser parse "--debug 0" } msg] $msg
} {0 {}}

test parseargs.298 {myParser parse "--debug 1000"} {
    list [catch { myParser parse "--debug 1000" } msg] $msg
} {0 {}}

test parseargs.299 {myParser parse "--debug -1000"} {
    list [catch { myParser parse "--debug -1000" } msg] $msg
} {0 {}}

test parseargs.300 {myParser parse "--debug -next"} {
...
test parseargs.302 {myParser argument configure "verbose" -min 1 -max 10} {
    list [catch { 
	myParser argument configure "verbose" -min 1 -max 10 
    } msg] $msg
} {0 {}}

test parseargs.303 {myParser argument configure "verbose" -min abc -max def} {
    list [catch { 
...
test parseargs.305 {myParser configure -error ""} {
    list [catch { myParser configure -error "" } msg] $msg
} {0 {}}

test parseargs.306 {myParser parse "--debug -next"} {
    list [catch { myParser parse "--debug -next" } msg] $msg
} {0 -next}

test parseargs.307 {myParser add type} {
   list [catch { myParser add type -short -t -long -type \
		     -choices "fish fowl" -default fish 
    } msg] $msg
} {0 type}

test parseargs.308 {myParser parse "-type fish"} {
    list [catch { myParser parse "-type fish" } msg] $msg
} {0 {}}

test parseargs.309 {myParser get "type"} {
    list [catch { myParser get "type" } msg] $msg
} {0 fish}

test parseargs.310 {myParser parse "-type fowl"} {
    list [catch { myParser parse "-type fowl" } msg] $msg
} {0 {}}

test parseargs.311 {myParser get "type"} {
    list [catch { myParser get "type" } msg] $msg
} {0 fowl}
...
test parseargs.313 {myParser parse "-type badValue"} {
...
test parseargs.315 {myParser argument configure "type"} {
    list [catch { 
	myParser argument configure "type" -type int -choices "1 5 10"
    } msg] $msg
} {0 {}}

test parseargs.316 {myParser parse "-type 5"} {
    list [catch { myParser parse "-type 5" } msg] $msg
} {0 {}}

test parseargs.317 {myParser parse "-type 1"} {
    list [catch { myParser parse "-type 1" } msg] $msg
} {0 {}}

test parseargs.318 {myParser parse "-type 10"} {
    list [catch { myParser parse "-type 10" } msg] $msg
} {0 {}}

test parseargs.319 {myParser parse "-type 7"} {
    list [catch { myParser parse "-type 7" } msg] $msg
} {1 {bad value "7", must be one of "1 5 10": bad value for "-type"}}

test parseargs.320 {myParser argument configure "type"} {
    list [catch { 
	myParser argument configure "type" -type float -choices "1 5 10"
    } msg] $msg
} {0 {}}

test parseargs.321 {myParser parse "-type 1e1"} {
    list [catch { myParser parse "-type 1e1" } msg] $msg
} {0 {}}

test parseargs.322 {myParser parse "-type 1 -type 10"} {
    list [catch { myParser parse "-type 1 -type 10" } msg] $msg
} {0 {}}

test parseargs.323 {myParser get "type"} {
    list [catch { myParser get "type" } msg] $msg
} {0 10}

test parseargs.324 {myParser parse "-type 1 -type 5 -type 10"} {
    list [catch { myParser parse "-type 1 -type 5 -type 10" } msg] $msg
} {0 {}}

test parseargs.325 {myParser get "type"} {
    list [catch { myParser get "type" } msg] $msg
} {0 10}


test parseargs.326 {myParser argument configure "type" -action append} {
    list [catch { myParser argument configure "type" -action append } msg] $msg
} {0 {}}

test parseargs.327 {myParser get "type"} {
    list [catch { myParser get "type" } msg] $msg
} {0 10}

test parseargs.328 {myParser parse "-type 1 -type 5 -type 10"} {
    list [catch { myParser parse "-type 1 -type 5 -type 10" } msg] $msg
} {0 {}}

test parseargs.329 {myParser get "type"} {
    list [catch { myParser get "type" } msg] $msg
} {0 {10 1 5 10}}

test parseargs.330 {myParser argument configure "type" -action store} {
    list [catch { myParser argument configure "type" -action store } msg] $msg
} {0 {}}

test parseargs.331 {myParser parse "-type 1e1"} {
    list [catch { myParser parse "-type 1e1" } msg] $msg
} {0 {}}
...
test parseargs.333 {myParser argument configure "type" -action store_true} {
    list [catch {
	myParser argument configure "type" -action store_true
    } msg] $msg
} {0 {}}

test parseargs.334 {myParser parse "-type 5"} {
    list [catch { myParser parse "-type 5" } msg] $msg
} {0 {}}
...
test parseargs.336 {myParser argument configure "type" -action store_false} {
    list [catch {
...
test parseargs.339 {myParser argument configure "type" -action store} {
    list [catch {
...
test parseargs.341 {myParser argument configure "type" -variable badVar} {
    list [catch {
	myParser argument configure "type" -variable ::arrayvar
    } msg] $msg
} {0 {}}

test parseargs.342 {myParser parse "-type 5"} {
    list [catch { myParser parse "-type 5" } msg] $msg
} {1 {can't set "::arrayvar": variable is array}}

test parseargs.343 {myParser argument configure "type" -variable ""} {
    list [catch {
...
test parseargs.345 {myParser parse "-date 1/1/1970"} {
    list [catch { myParser parse "-date 1/1/1970" } msg] $msg
} {0 {}}


test parseargs.346 {myParser get "date"} {
    list [catch { myParser get "date" } msg] $msg
} {0 0}

test parseargs.347 {myParser argument configure "type" -required yes} {
    list [catch {
	myParser argument configure "type" -required yes
    } msg] $msg
} {0 {}}

test parseargs.348 {myParser reset} {
    list [catch { myParser reset } msg] $msg
} {0 {}}

test parseargs.349 {myParser parse "-date 1/1/1970"} {
    list [catch { myParser parse "-date 1/1/1970" } msg] $msg
} {1 {missing required argument "-type"}}

test parseargs.350 {myParser get "date"} {
    list [catch { myParser get "date" } msg] $msg
} {0 0}

test parseargs.351 {myParser exists "date"} {
    list [catch { myParser exists "date" } msg] $msg
} {0 1}

test parseargs.352 {myParser exists "type"} {
    list [catch { myParser exists "type" } msg] $msg
} {0 1}

test parseargs.353 {myParser delete (no arg)} {
    list [catch { myParser delete } msg] $msg
} {0 {}}

test parseargs.354 {myParser delete badArg} {
    list [catch { myParser delete badArg } msg] $msg
} {1 {can't find argument "badArg" in parser "::myParser"}}

test parseargs.355 {myParser delete "type" "verbose" } {
    list [catch { myParser delete "type" "verbose" } msg] $msg
} {0 {}}

test parseargs.356 {myParser exists "type"} {
    list [catch { myParser exists "type" } msg] $msg
} {0 0}

test parseargs.357 {myParser get} { 
    list [catch { myParser get } msg] $msg 
} {0 {debug 0 date 0}}

test parseargs.358 {myParser parse "-date 1/2/1970 e f g"} {
    list [catch { 
	myParser parse "-date 1/2/1970 e f g" 
    } msg] $msg
} {0 {e f g}}

test parseargs.359 {myParser parse "a b c -date 1/2/1970 e f g"} {
    list [catch { 
	myParser parse "a b c -date 1/2/1970 e f g" 
    } msg] $msg
} {0 {a b c e f g}}

test parseargs.360 {myParser parse "--debug a b c -date 1/2/1970 e f g"} {
    list [catch { 
	myParser parse "a b --debug 0 c d -date 1/2/1970 e f g" 
    } msg] $msg
} {0 {a b c d e f g}}

test parseargs.361 {myParser add files} {
    list [catch { 
	myParser add files -short -f -long -files -nargs * -metavar file
    } msg] $msg
} {0 files}

test parseargs.362 {myParser parse "-f"} {
    list [catch { myParser parse "-f" } msg] $msg
} {0 {}}

test parseargs.363 {myParser get files} { 
    list [catch { myParser get files } msg] $msg 
} {0 {}}

test parseargs.364 {myParser parse "-f a b c"} {
    list [catch { myParser parse "-f a b c" } msg] $msg
} {0 {}}

test parseargs.365 {myParser get files} { 
    list [catch { myParser get files } msg] $msg 
} {0 {a b c}}

test parseargs.366 {myParser parse "--debug -f a b c"} {
    list [catch { myParser parse "--debug -f a b c" } msg] $msg
} {0 {}}

test parseargs.367 {myParser parse "-f a b c -date 1/2/1970 e f g"} {
    list [catch { 
	myParser reset
...
test parseargs.368 {myParser parse "0 1 2 3 --debug -f a b c -date 1/1/1970 e f g"} {
    list [catch { 
	myParser reset
...
test parseargs.369 {myParser parse "0 1 2 3 --debug -f -date 1/1/1970 e f g"} {
    list [catch { 
	myParser reset
...
test parseargs.370 {myParser parse "0 1 2 3 --debug -f c -date 1/1/1970 e f g"} {
    list [catch { 
	myParser reset
...
test parseargs.371 {myParser parse "0 1 2 3 --debug -f c d -date 1/1/1970 e f g"} {
    list [catch { 
	myParser reset
...
test parseargs.372 {myParser get} {
    list [catch { myParser get } msg] $msg
} {0 {debug 0 date 0 files {c d}}}

test parseargs.373 {myParser argument configure files -nargs 3} {
    list [catch { myParser argument configure files -nargs 3 } msg] $msg
} {0 {}}

test parseargs.374 {myParser parse "-f a b c"} {
    list [catch { 
	myParser reset
...
test parseargs.375 {myParser parse "-f a b c -d"} {
    list [catch { 
	myParser reset
...
test parseargs.376 {myParser parse "-f a b c d"} {
    list [catch { 
	myParser reset
	myParser parse "-f a b c d" 
    } msg] $msg
...
test parseargs.377 {myParser parse "-f"} {
    list [catch { 
	myParser reset
	myParser parse "-f" 
    } msg] $msg
...
test parseargs.378 {myParser parse "-f a"} {
    list [catch { 
	myParser reset
	myParser parse "-f a" 
    } msg] $msg
...
test parseargs.379 {myParser parse "-f a b"} {
    list [catch { 
	myParser reset
...
test parseargs.381 {myParser parse "-d 0"} {
    list [catch { 
	myParser reset
	myParser parse "-d 0" 
    } msg] $msg
...
test parseargs.382 {myParser parse "0 1 2 3 --debug -f c d -date 1/1/1970 e f g"} {
    list [catch { 
	myParser reset
	myParser parse "0 1 2 3 --debug -f c d -date 1/1/1970 e f g" 
    } msg] $msg
...
test parseargs.383 {myParser argument configure files -nargs +} {
    list [catch { myParser argument configure files -nargs + } msg] $msg
} {0 {}}

test parseargs.384 {myParser parse "-f a b c d"} {
    list [catch { 
	myParser reset
	myParser parse "-f a b c d" 
    } msg] $msg
...
test parseargs.385 {myParser parse "-f"} {
    list [catch { 
	myParser reset
	myParser parse "-f" 
    } msg] $msg
...
test parseargs.386 {myParser parse "-f a"} {
    list [catch { 
	myParser reset
	myParser parse "-f a" 
    } msg] $msg
...
test parseargs.387 {myParser parse "-f a b"} {
    list [catch { 
	myParser reset
	myParser parse "-f a b" 
    } msg] $msg
...
test parseargs.388 {myParser parse "-f a b c"} {
    list [catch { 
	myParser reset
	myParser parse "-f a b c" 
    } msg] $msg
...
test parseargs.389 {myParser parse "-f a b c -d"} {
    list [catch { 
	myParser reset
	myParser parse "-f a b c -d" 
    } msg] $msg
...
test parseargs.390 {myParser get files} { 
    list [catch { myParser get files } msg] $msg 
} {0 {a b c}}

test parseargs.391 {myParser argument configure files -nargs 0} {
    list [catch { myParser argument configure files -nargs 0 } msg] $msg
} {0 {}}

test parseargs.392 {myParser parse "-f a b c d"} {
    list [catch { 
	myParser reset
	myParser parse "-f a b c d" 
    } msg] $msg
...
test parseargs.393 {myParser parse "-f"} {
    list [catch { 
	myParser reset
	myParser parse "-f" 
    } msg] $msg
...
test parseargs.394 {myParser parse "-f a"} {
    list [catch { 
	myParser reset
	myParser parse "-f a" 
    } msg] $msg
...
test parseargs.395 {myParser parse "-f a b"} {
    list [catch { 
	myParser reset
	myParser parse "-f a b" 
    } msg] $msg
...
test parseargs.396 {myParser parse "-f a b c"} {
    list [catch { 
	myParser reset
	myParser parse "-f a b c" 
    } msg] $msg
...
test parseargs.397 {myParser parse "-f a b c -d"} {
    list [catch { 
	myParser reset
	myParser parse "-f a b c -d" 
    } msg] $msg
...
test parseargs.398 {myParser get files} { 
    list [catch { myParser get files } msg] $msg 
} {0 {}}

test parseargs.399 {myParser add things} {
    list [catch { 
	myParser add things -nargs *
    } msg] $msg
} {0 things}

test parseargs.400 {myParser parse "a b c -d"} {
    list [catch { 
	myParser reset
...
test parseargs.401 {myParser get } { 
    list [catch { myParser get } msg] $msg 
} {0 {debug 0 date {} files {} things {a b c}}}

test parseargs.402 {myParser parse "-f a b c -d"} {
    list [catch { 
	myParser reset
	myParser parse "-f a b c -d" 
    } msg] $msg
...
test parseargs.403 {myParser get } { 
    list [catch { myParser get } msg] $msg 
} {0 {debug 0 date {} files {} things {a b c}}}

test parseargs.404 {myParser parse ""} {
    list [catch { 
	myParser reset
	myParser parse "" 
    } msg] $msg
...
test parseargs.405 {myParser get } { 
    list [catch { myParser get } msg] $msg 
} {0 {debug 0 date {} files {} things {}}}

test parseargs.406 {myParser parse "a"} {
    list [catch { 
	myParser reset
	myParser parse "a" 
    } msg] $msg
...
test parseargs.408 {myParser parse "a b -d"} {
    list [catch { 
	myParser reset
...
test parseargs.410 {myParser delete things } {
    list [catch { myParser delete things } msg] $msg
} {0 {}}

test parseargs.411 {myParser add first } {
    list [catch { myParser add first } msg] $msg
} {0 first}

test parseargs.412 {myParser add second } {
    list [catch { myParser add second } msg] $msg
} {0 second}

test parseargs.413 {myParser add third } {
    list [catch { myParser add third } msg] $msg
} {0 third}

test parseargs.414 {myParser parse ""} {
    list [catch { 
	myParser reset
	myParser parse "" 
    } msg] $msg
...
test parseargs.416 {myParser parse "a"} {
    list [catch { 
	myParser reset
	myParser parse "a" 
    } msg] $msg
...
test parseargs.417 {myParser get} {
    list [catch { myParser get } msg] $msg
} {0 {debug 0 date {} files {} first a second {} third {}}}

test parseargs.418 {myParser parse "a b"} {
    list [catch { 
	myParser reset
	myParser parse "a b" 
    } msg] $msg
...
test parseargs.419 {myParser get} {
    list [catch { myParser get } msg] $msg
} {0 {debug 0 date {} files {} first a second b third {}}}

test parseargs.420 {myParser parse "a b c"} {
    list [catch { 
	myParser reset
...
test parseargs.422 {myParser parse "a b c d"} {
    list [catch { 
	myParser reset
	myParser parse "a b c d" 
    } msg] $msg
...
test parseargs.424 {myParser add fahrenheit} {
    list [catch {
...
test parseargs.425 {myParser add centigrade} {
    list [catch {
...
test parseargs.426 {myParser parse "--fahrenheit"} {
    list [catch { 
	myParser reset
...
test parseargs.427 {myParser parse "--centigrade"} {
    list [catch { 
	myParser reset
...
test parseargs.428 {myParser parse "--fahrenheit --centigrade"} {
    list [catch { 
	myParser reset
...
test parseargs.429 {myParser parse "--centigrade --fahrenheit"} {
    list [catch { 
	myParser reset
...
test parseargs.430 {myParser delete "fahrenheit" "centigrade" } {
...
test parseargs.439 {myParser parse ""} {
    list [catch { 
	myParser reset
	myParser parse "" 
    } msg] $msg
...
test parseargs.440 {myParser get test} {
    list [catch { myParser get test } msg] $msg
} {0 NA}

test parseargs.441 {myParser parse "-t"} {
    list [catch { 
	myParser reset
	myParser parse "-t" 
    } msg] $msg
...
test parseargs.442 {myParser get test} {
    list [catch { myParser get test } msg] $msg
} {0 10}

test parseargs.443 {myParser configure test -value NA} {
    list [catch {
	myParser argument configure test -value NA 
    } msg] $msg
} {0 {}}

test parseargs.444 {myParser parse "-t"} {
    list [catch { 
	myParser reset
	myParser parse "-t" 
    } msg] $msg
...
test parseargs.445 {myParser get test} {
    list [catch { myParser get test } msg] $msg
} {0 NA}

test parseargs.446 {myParser configure test -value 0} {
    list [catch {
	myParser argument configure test -value 0
    } msg] $msg
} {0 {}}

test parseargs.447 {myParser delete first second third} {
    list [catch { myParser delete first second third } msg] $msg
} {0 {}}

test parseargs.448 {myParser add --} {
    list [catch { myParser add -- -short -- -nargs last } msg] $msg
} {0 --}

test parseargs.449 {myParser parse "-t -- -t --debug --files" } {
    list [catch { 
	myParser reset
...
test parseargs.451 {myParser get} {
    list [catch { myParser get } msg] $msg
...
test parseargs.453 {myParser argument configure test} {
    list [catch { 
...
test parseargs.454 {myParser parse "-t -d --debug -f -files" } {
    list [catch { 
	myParser reset
...
test parseargs.455 {myParser get test} {
    list [catch { myParser get test } msg] $msg
} {0 {-d --debug -f -files}}
...
test parseargs.413 {myParser add long } {
    list [catch {
