...
test parseargs.142 {parseargs0 dump 1 -version 2.0} {
...
test parseargs.143 {parseargs0 dump this -version 2.0} {
...
test parseargs.144 {parseargs0 dump 1 badSwitch} {
...
test parseargs.208 {parseargs0 restore 0 -file test.dump} {
    list [catch {
	blt::parseargs create
...
test parseargs.209 {parseargs0 unset 0 key1} {
    list [catch {parseargs0 unset 0 key1} msg] $msg
} {0 {}}

test parseargs.210 {parseargs0 get 0} {
    list [catch {parseargs0 get 0} msg] $msg
} {0 {key value key2 value2 key3 value3 abc 123}}

test parseargs.211 {parseargs0 unset 0 key2 key3} {
    list [catch {parseargs0 unset 0 key2 key3} msg] $msg
} {0 {}}

test parseargs.212 {parseargs0 get 0} {
    list [catch {parseargs0 get 0} msg] $msg
} {0 {key value abc 123}}

test parseargs.213 {parseargs0 unset 0} {
    list [catch {parseargs0 unset 0} msg] $msg
} {0 {}}

test parseargs.214 {parseargs0 get 0} {
    list [catch {parseargs0 get 0} msg] $msg
} {0 {}}

test parseargs.215 {parseargs0 unset all abc} {
    list [catch {parseargs0 unset all abc} msg] $msg
} {0 {}}

test parseargs.216 {parseargs0 restore stuff} {
    list [catch {
	set data [parseargs0 dump root -version 2.0]
...
test parseargs.217 {parseargs0 restore (missing arg)} {
    list [catch {parseargs0 restore} msg] $msg
} {1 {wrong # args: should be "parseargs0 restore nodeName ?switches ...?"}}

test parseargs.218 {parseargs0 restore 0 badSwitch} {
...
test parseargs.219 {parseargs0 restore 0 {} arg (extra arg)} {
...
test parseargs.220 {parseargs0 size (missing arg)} {
    list [catch {parseargs0 size} msg] $msg
} {1 {wrong # args: should be "parseargs0 size nodeName"}}

test parseargs.221 {parseargs0 size 0} {
    list [catch {parseargs0 size 0} msg] $msg
} {0 12}

test parseargs.222 {parseargs0 size all} {
    list [catch {parseargs0 size all} msg] $msg
} {1 {tag "all" refers to more than one node.}}

test parseargs.223 {parseargs0 size 0 10 (extra arg)} {
    list [catch {parseargs0 size 0 10} msg] $msg
} {1 {wrong # args: should be "parseargs0 size nodeName"}}

test parseargs.224 {parseargs0 delete (no args)} {
    list [catch {parseargs0 delete} msg] $msg
} {0 {}}

test parseargs.225 {parseargs0 delete 11} {
    list [catch {parseargs0 delete 11} msg] $msg
} {0 {}}

test parseargs.226 {parseargs0 delete 11} {
    list [catch {parseargs0 delete 11} msg] $msg
} {1 {can't find tag or id "11" in ::parseargs0}}

test parseargs.227 {parseargs0 delete 9 12} {
    list [catch {parseargs0 delete 9 12} msg] $msg
} {0 {}}

test parseargs.228 {parseargs0 dump 0 -version 2.0} {
...
test parseargs.230 {delete all all} {
    list [catch {
	set data [parseargs0 dump root -version 2.0]
	blt::parseargs create
	parseargs1 restore root -data $data
...
test parseargs.231 {parseargs0 apply (missing arg)} {
    list [catch {parseargs0 apply} msg] $msg
} {1 {wrong # args: should be "parseargs0 apply nodeName ?switches ...?"}}

test parseargs.232 {parseargs0 apply 0} {
    list [catch {parseargs0 apply 0} msg] $msg
} {0 {}}

test parseargs.233 {parseargs0 apply 0 -badSwitch} {
...
test parseargs.234 {parseargs0 apply badTag} {
    list [catch {parseargs0 apply badTag} msg] $msg
} {1 {can't find tag or id "badTag" in ::parseargs0}}

test parseargs.235 {parseargs0 apply all} {
    list [catch {parseargs0 apply all} msg] $msg
} {1 {tag "all" refers to more than one node.}}

test parseargs.236 {parseargs0 apply myTag -precommand lappend} {
    list [catch {
	set mylist {}
...
test parseargs.237 {parseargs0 apply root -precommand lappend} {
    list [catch {
	set mylist {}
...
test parseargs.238 {parseargs0 apply -postcommand} {
    list [catch {
	set mylist {}
...
test parseargs.239 {parseargs0 apply -precommand -postcommand} {
    list [catch {
	set mylist {}
	parseargs0 apply root -precommand {lappend mylist} \
...
test parseargs.240 {parseargs0 apply root -precommand lappend -depth 1} {
    list [catch {
	set mylist {}
...
test parseargs.241 {parseargs0 apply root -precommand -depth 0} {
    list [catch {
	set mylist {}
...
test parseargs.242 {parseargs0 apply root -precommand -tag myTag} {
    list [catch {
	set mylist {}
...
test parseargs.243 {parseargs0 apply root -precommand -key key1} {
    list [catch {
	set mylist {}
...
test parseargs.244 {parseargs0 apply root -postcommand -regexp node.*} {
    list [catch {
	set mylist {}
	parseargs0 set myTag key1 0.0
...
test parseargs.245 {parseargs0 find (missing arg)} {
    list [catch {parseargs0 find} msg] $msg
} {1 {wrong # args: should be "parseargs0 find nodeName ?switches ...?"}}

test parseargs.246 {parseargs0 find 0} {
    list [catch {parseargs0 find 0} msg] $msg
} {0 {1 2 3 4 13 5 6 8 0}}

test parseargs.247 {parseargs0 find root} {
    list [catch {parseargs0 find root} msg] $msg
} {0 {1 2 3 4 13 5 6 8 0}}

test parseargs.248 {parseargs0 find 0 -glob node*} {
    list [catch {parseargs0 find root -glob node*} msg] $msg
} {0 {1 2 3 4 13 5 6}}

test parseargs.249 {parseargs0 find 0 -glob nobody} {
    list [catch {parseargs0 find root -glob nobody} msg] $msg
} {0 {}}

test parseargs.250 {parseargs0 find 0 -regexp {node[0-3]}} {
    list [catch {parseargs0 find root -regexp {node[0-3]}} msg] $msg
} {0 {1 2 3 13}}

test parseargs.251 {parseargs0 find 0 -regexp {.*[A-Z].*}} {
    list [catch {parseargs0 find root -regexp {.*[A-Z].*}} msg] $msg
} {0 8}

test parseargs.252 {parseargs0 find 0 -exact myLabel} {
    list [catch {parseargs0 find root -exact myLabel} msg] $msg
} {0 8}

test parseargs.253 {parseargs0 find 0 -exact myLabel -invert} {
    list [catch {parseargs0 find root -exact myLabel -invert} msg] $msg
} {0 {1 2 3 4 13 5 6 0}}


test parseargs.254 {parseargs0 find 3 -exact node3} {
    list [catch {parseargs0 find 3 -exact node3} msg] $msg
} {0 3}

test parseargs.255 {parseargs0 find 0 -nocase -exact mylabel} {
    list [catch {parseargs0 find 0 -nocase -exact mylabel} msg] $msg
} {0 8}

test parseargs.256 {parseargs0 find 0 -nocase} {
    list [catch {parseargs0 find 0 -nocase} msg] $msg
} {0 {1 2 3 4 13 5 6 8 0}}

test parseargs.257 {parseargs0 find 0 -path -nocase -glob *node1* } {
    list [catch {parseargs0 find 0 -path -nocase -glob *node1*} msg] $msg
} {0 {1 13}}

test parseargs.258 {parseargs0 find 0 -count 5 } {
    list [catch {parseargs0 find 0 -count 5} msg] $msg
} {0 {1 2 3 4 13}}

test parseargs.259 {parseargs0 find 0 -count -5 } {
    list [catch {parseargs0 find 0 -count -5} msg] $msg
} {1 {bad value "-5": can't be negative}}

test parseargs.260 {parseargs0 find 0 -count badValue } {
    list [catch {parseargs0 find 0 -count badValue} msg] $msg
} {1 {expected integer but got "badValue"}}

test parseargs.261 {parseargs0 find 0 -count badValue } {
    list [catch {parseargs0 find 0 -count badValue} msg] $msg
} {1 {expected integer but got "badValue"}}

test parseargs.262 {parseargs0 find 0 -leafonly} {
    list [catch {parseargs0 find 0 -leafonly} msg] $msg
} {0 {1 2 3 4 13 6 8}}

test parseargs.263 {parseargs0 find 0 -leafonly -glob {node[18]}} {
    list [catch {parseargs0 find 0 -glob {node[18]} -leafonly} msg] $msg
} {0 1}

test parseargs.264 {parseargs0 find 0 -depth 0} {
    list [catch {parseargs0 find 0 -depth 0} msg] $msg
} {0 0}

test parseargs.265 {parseargs0 find 0 -depth 1} {
    list [catch {parseargs0 find 0 -depth 1} msg] $msg
} {0 {1 2 3 4 5 6 8 0}}

test parseargs.266 {parseargs0 find 0 -depth 2} {
    list [catch {parseargs0 find 0 -depth 2} msg] $msg
} {0 {1 2 3 4 13 5 6 8 0}}

test parseargs.267 {parseargs0 find 0 -depth 20} {
    list [catch {parseargs0 find 0 -depth 20} msg] $msg
} {0 {1 2 3 4 13 5 6 8 0}}

test parseargs.268 {parseargs0 find 1 -depth 0} {
    list [catch {parseargs0 find 1 -depth 0} msg] $msg
} {0 1}

test parseargs.269 {parseargs0 find 1 -depth 1} {
    list [catch {parseargs0 find 1 -depth 1} msg] $msg
} {0 1}

test parseargs.270 {parseargs0 find 1 -depth 2} {
    list [catch {parseargs0 find 1 -depth 2} msg] $msg
} {0 1}

test parseargs.271 {parseargs0 find all} {
    list [catch {parseargs0 find all} msg] $msg
} {1 {tag "all" refers to more than one node.}}

test parseargs.272 {parseargs0 find badTag} {
    list [catch {parseargs0 find badTag} msg] $msg
} {1 {can't find tag or id "badTag" in ::parseargs0}}

test parseargs.273 {parseargs0 find 0 -addtag hi} {
    list [catch {parseargs0 find 0 -addtag hi} msg] $msg
} {0 {1 2 3 4 13 5 6 8 0}}

test parseargs.274 {parseargs0 find 0 -addtag all} {
    list [catch {parseargs0 find 0 -addtag all} msg] $msg
} {0 {1 2 3 4 13 5 6 8 0}}

test parseargs.275 {parseargs0 find 0 -addtag root} {
    list [catch {parseargs0 find 0 -addtag root} msg] $msg
} {1 {can't add reserved tag "root"}}

test parseargs.276 {parseargs0 find 0 -exec {lappend list} -leafonly} {
    list [catch {
	set list {}
...
test parseargs.277 {parseargs0 find 0 -tag root} {
    list [catch {parseargs0 find 0 -tag root} msg] $msg
} {0 0}

test parseargs.278 {parseargs0 find 0 -tag myTag} {
    list [catch {parseargs0 find 0 -tag myTag} msg] $msg
} {0 5}

test parseargs.279 {parseargs0 find 0 -tag badTag} {
    list [catch {parseargs0 find 0 -tag badTag} msg] $msg
} {0 {}}

test parseargs.280 {parseargs0 tag (missing args)} {
    list [catch {parseargs0 tag} msg] $msg
} {1 {wrong # args: should be "parseargs0 tag args ..."}}

test parseargs.281 {parseargs0 tag badOp} {
...
test parseargs.311 {parseargs0 path (missing arg)} {
    list [catch {parseargs0 path} msg] $msg
} {1 {wrong # args: should be "parseargs0 path ?args ...?"}}

test parseargs.312 {parseargs0 path badArg} {
...
test parseargs.313 {parseargs0 path print root} {
    list [catch {parseargs0 path print root} msg] $msg
} {0 {}}

test parseargs.314 {parseargs0 path print 0} {
    list [catch {parseargs0 path print 0} msg] $msg
} {0 {}}

test parseargs.315 {parseargs0 path print 15} {
    list [catch {parseargs0 path print 15} msg] $msg
} {0 {node1 node15}}

test parseargs.316 {parseargs0 path print 15} {
    list [catch {parseargs0 path print 15 -separator /} msg] $msg
} {0 /node1/node15}

test parseargs.317 {parseargs0 path print 16} {
    list [catch {parseargs0 path print 16 -separator /} msg] $msg
} {0 /node1/node14/node16}

test parseargs.318 {parseargs0 path parse /} {
    list [catch {parseargs0 path parse / -separator /} msg] $msg
} {0 0}

test parseargs.319 {parseargs0 path parse /node1} {
    list [catch {parseargs0 path parse /node1 -separator /} msg] $msg
} {0 1}

test parseargs.320 {parseargs0 path parse /node1/node14} {
    list [catch {parseargs0 path parse /node1/node14 -separator /} msg] $msg
} {0 14}

test parseargs.321 {parseargs0 path parse } {
    list [catch {parseargs0 path parse /node1/node14/node16 -separator /} msg] $msg
} {0 16}

test parseargs.322 {parseargs0 path parse } {
    list [catch {parseargs0 path parse /node1/node14/node16/ -separator /} msg] $msg
} {0 16}

test parseargs.323 {parseargs0 path parse } {
    list [catch {parseargs0 path parse //node1//node14//node16// -separator /} msg] $msg
} {0 16}

test parseargs.324 {parseargs0 path parse } {
    list [catch {parseargs0 path parse ::node1::node14::node16 -separator ::} msg] $msg
} {0 16}

test parseargs.325 {parseargs0 path parse } {
    list [catch {parseargs0 path parse /node1/node14/node16 -separator /} msg] $msg
} {0 16}

test parseargs.326 {parseargs0 path parse } {
    list [catch {parseargs0 path parse /node1/node14/node16/ -separator /} msg] $msg
} {0 16}

test parseargs.327 {parseargs0 path parse } {
    list [catch {parseargs0 path parse //node1//node14//node16// -separator /} msg] $msg
} {0 16}

test parseargs.328 {parseargs0 path parse } {
    list [catch {parseargs0 path parse ::node1::node14::node16 -separator ::} msg] $msg
} {0 16}

test parseargs.329 {parseargs0 path parse ""} {
    list [catch {parseargs0 path parse {}} msg] $msg
} {0 0}

test parseargs.330 {parseargs0 path parse node1 } {
    list [catch {parseargs0 path parse node1} msg] $msg
} {0 1}

test parseargs.331 {parseargs0 path parse {node1 node14}} {
    list [catch {parseargs0 path parse {node1 node14}} msg] $msg
} {0 14}

test parseargs.332 {parseargs0 path parse } {
    list [catch {parseargs0 path parse {node1 node14 node16}} msg] $msg
} {0 16}


test parseargs.333 {parseargs0 path print all} {
    list [catch {parseargs0 path print all} msg] $msg
} {1 {tag "all" refers to more than one node.}}

test parseargs.334 {parseargs0 path print 0 badSwitch} {
...
test parseargs.337 {parseargs0 tag forget hi} {
    list [catch {
...
test parseargs.338 {parseargs0 tag forget tag1 tag2} {
    list [catch {
...
test parseargs.339 {parseargs0 tag forget all} {
    list [catch {
...
test parseargs.340 {parseargs0 tag forget root} {
    list [catch {
...
test parseargs.351 {parseargs0 move 1 0 -after 2} {
    list [catch {
...
test parseargs.352 {parseargs0 move 1 2} {
    list [catch {
	parseargs0 move 1 2
	parseargs0 children 0
    } msg] $msg
...
test parseargs.357 {parseargs1 attach parseargs0 -newtags} {
    list [catch {
	blt::parseargs create
...
test parseargs.358 {parseargs1 attach parseargs0} {
    list [catch {
	blt::parseargs create
...
test parseargs.359 {parseargs1 attach ""} {
    list [catch {parseargs1 attach ""} msg] $msg
} {0 {}}


test parseargs.360 {blt::parseargs destroy parseargs1} {
    list [catch {blt::parseargs destroy parseargs1} msg] $msg
} {0 {}}

test parseargs.361 {parseargs0 find root -badSwitch} {
...
test parseargs.362 {parseargs0 find root -order} {
    list [catch {parseargs0 find root -order} msg] $msg
} {1 {value for "-order" missing}}

test parseargs.363 {parseargs0 find root ...} {
...
test parseargs.386 {parseargs0 sort 0 -decreasing} {
    list [catch {parseargs0 sort 0 -decreasing} msg] $msg
} {0 {6 5 4 3 2 8}}

test parseargs.387 {parseargs0 sort 0} {
    list [catch {
	set list {}
...
test parseargs.388 {parseargs0 sort 0 -decreasing} {
    list [catch {parseargs0 sort 0 -decreasing} msg] $msg
} {0 {6 5 4 3 2 8}}


test parseargs.389 {parseargs0 sort 0 -decreasing -key} {
    list [catch {parseargs0 sort 0 -decreasing -key} msg] $msg
} {1 {value for "-key" missing}}

test parseargs.390 {parseargs0 sort 0 -decreasing -key key1} {
    list [catch {parseargs0 sort 0 -decreasing -key key1} msg] $msg
} {0 {8 6 5 4 3 2}}

test parseargs.391 {parseargs0 sort 0 -decreasing -recurse -key key1} {
    list [catch {parseargs0 sort 0 -decreasing -recurse -key key1} msg] $msg
} {0 {15 16 0 1 2 3 4 5 6 8 13 14 17 18 19 20 21}}

test parseargs.392 {parseargs0 sort 0 -decreasing -key key1} {
    list [catch {
	set list {}
...
test parseargs.406 {parseargs0 trace create} {
...
test parseargs.407 {parseargs0 trace create root} {
    list [catch {parseargs0 trace create root} msg] $msg
} {1 {wrong # args: should be "parseargs0 trace create nodeName key how command ?-whenidle?"}}

test parseargs.408 {parseargs0 trace create root * } {
    list [catch {parseargs0 trace create root * } msg] $msg
} {1 {wrong # args: should be "parseargs0 trace create nodeName key how command ?-whenidle?"}}

test parseargs.409 {parseargs0 trace create root * rwuc} {
    list [catch {parseargs0 trace create root * rwuc} msg] $msg
} {1 {wrong # args: should be "parseargs0 trace create nodeName key how command ?-whenidle?"}}

proc Doit args { global mylist; lappend mylist $args }

test parseargs.410 {parseargs0 trace create all newKey rwuc Doit} {
    list [catch {parseargs0 trace create all newKey rwuc Doit} msg] $msg
} {0 trace0}

test parseargs.411 {parseargs0 trace info trace0} {
    list [catch {parseargs0 trace info trace0} msg] $msg
} {0 {all newKey rwuc Doit}}

test parseargs.412 {test create trace} {
    list [catch {
	set mylist {}
...
test parseargs.413 {test read trace} {
    list [catch {
	set mylist {}
...
test parseargs.414 {test write trace} {
    list [catch {
	set mylist {}
...
test parseargs.415 {test unset trace} {
    list [catch {
	set mylist {}
	parseargs0 set all newKey 21
	set mylist
...
test parseargs.416 {parseargs0 trace delete} {
    list [catch {parseargs0 trace delete} msg] $msg
} {0 {}}

test parseargs.417 {parseargs0 trace delete badId} {
    list [catch {parseargs0 trace delete badId} msg] $msg
} {1 {unknown trace "badId"}}

test parseargs.418 {parseargs0 trace delete trace0} {
    list [catch {parseargs0 trace delete trace0} msg] $msg
} {0 {}}

test parseargs.419 {test create trace} {
    list [catch {
	set mylist {}
	parseargs0 set all newKey 20
	set mylist
...
test parseargs.420 {test unset trace} {
    list [catch {
	set mylist {}
...
test parseargs.421 {parseargs0 notify} {
...
test parseargs.429 {test move notify} {
    list [catch {
	set mylist {}
...
test parseargs.430 {test sort notify} {
    list [catch {
	set mylist {}
...
test parseargs.431 {test relabel notify} {
    list [catch {
	set mylist {}
...
test parseargs.432 {test delete notify} {
    list [catch {
	set mylist {}
...
test parseargs.433 {parseargs0 notify delete badId} {
    list [catch {parseargs0 notify delete badId} msg] $msg
} {1 {unknown notify name "badId"}}


test parseargs.434 {test create notify} {
    list [catch {
	set mylist {}
	parseargs0 set all newKey 20
	set mylist
...
test parseargs.435 {test delete notify} {
    list [catch {
	set mylist {}
	parseargs0 unset all newKey
	set mylist
...
test parseargs.436 {test delete notify} {
    list [catch {
	set mylist {}
	parseargs0 unset all newKey
	set mylist
...
test parseargs.444 {parseargs dir (no recurse flag)} {
    list [catch {
...
test parseargs.445 {parseargs dir -recurse} {
    list [catch {
	file delete -force ./testdir
...
test parseargs.446 {parseargs dir -recurse} {
    list [catch {
	file delete -force ./testdir
	file mkdir ./testdir
...
test parseargs.447 {parseargs dir (default settings, no -recurse)} {
    list [catch {
	file delete -force ./testdir
	file mkdir ./testdir/dir1
	file copy defs ./testdir/dir1
...
test parseargs.448 {parseargs dir -type "file pipe"} {
    list [catch {
	set parseargs [blt::parseargs create]
...
test parseargs.449 {parseargs dir -type link -recurse} {
    list [catch {
	file delete -force ./testdir
	file mkdir ./testdir/dir1
	file copy defs ./testdir/dir1
