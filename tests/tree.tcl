...
test tree.33 {tree destroy tree0 tree1} {
    list [catch {blt::tree destroy tree0 tree1} msg] $msg
} {0 {}}

test tree.34 {exists tree0} {
    list [catch {blt::tree exists tree0} msg] $msg
} {0 0}

test tree.35 {exists tree1} {
...
test tree.135 {tree0 dump 1 -version 2.0} {
...
test tree.136 {tree0 dump this -version 2.0} {
...
test tree.137 {tree0 dump 1 badSwitch} {
...
test tree.345 {myTree export} {
    list [catch {myTree export} msg] $msg
} {0 {}}

test tree.346 {myTree import} {
    list [catch {myTree import} msg] $msg
} {0 {}}

test tree.347 {package require blt_tree_xml} {
    list [catch {package require blt_tree_xml} msg] $msg
} {0 3.0}

test tree.348 {myTree export} {
    list [catch {myTree export} msg] $msg
} {0 xml}

test tree.349 {myTree import} {
    list [catch {myTree import} msg] $msg
} {0 xml}

test tree.350 {package require blt_tree_json} {
    list [catch {package require blt_tree_json} msg] $msg
} {0 3.0}

test tree.351 {myTree export} {
    list [catch {myTree export} msg] $msg
} {0 {xml json}}

test tree.352 {myTree export badFmt} {
    list [catch {myTree export badFmt} msg] $msg
} {1 {can't export "badFmt": format not registered}}

test tree.353 {myTree export json} {
...
test tree.354 {myTree export json -help} {
...
test tree.355 {myTree export json -badSwitch} {
...
test tree.356 {myTree export json -root badNode} {
    list [catch {myTree export json -root badNode} msg] $msg
} {1 {can't find tag or id "badNode" in ::myTree}}

test tree.357 {myTree export json -root (missing arg)} {
    list [catch {myTree export json -root} msg] $msg
} {1 {value for "-root" missing}}

test tree.358 {myTree export json -root 1} {
    list [catch {myTree export json -root 1} msg] $msg
} {0 {{
}
}}

test tree.359 {myTree export json -file (missing arg)} {
    list [catch {myTree export json -file} msg] $msg
} {1 {value for "-file" missing}}

test tree.360 {myTree export json -file badDir/badFile} {
...
test tree.361 {myTree export json -file testDir/noPerms.json} {
    list [catch {
...
test tree.362 {myTree export json -file testDir/myTree.json} {
    list [catch {
...
test tree.367 {myTree export xml -help} {
...
test tree.368 {myTree export xml -badSwitch} {
...
test tree.369 {myTree export xml -root badNode} {
    list [catch {myTree export xml -root badNode} msg] $msg
} {1 {can't find tag or id "badNode" in ::myTree}}

test tree.370 {myTree export xml -root (missing arg)} {
    list [catch {myTree export xml -root} msg] $msg
} {1 {value for "-root" missing}}

test tree.371 {myTree export xml} {
...
test tree.372 {myTree export xml -root 1} {
    list [catch {myTree export xml -root 1} msg] $msg
} {0 {
 <child1></child1>
}}

test tree.373 {myTree export xml -file (missing arg)} {
    list [catch {myTree export xml -file} msg] $msg
} {1 {value for "-file" missing}}

test tree.374 {myTree export xml -file badDir/badFile} {
    list [catch {myTree export xml -file badDir/badFile} msg] $msg
} {1 {couldn't open "badDir/badFile": no such file or directory}}

MakeTestFile noPerms.xml 0500 ""

test tree.375 {myTree export xml -file testDir/noPerms.xml} {
    list [catch {
...
test tree.376 {myTree export xml -file testDir/myTree.xml} {
    list [catch {
...
test tree.377 {myTree export xml -data (missing arg)} {
    list [catch {myTree export xml -data} msg] $msg
} {1 {value for "-data" missing}}

test tree.378 {myTree export xml -data badNs::badVar} {
    list [catch {myTree export xml -data badNs::badVar} msg] $msg
} {1 {can't set "badNs::badVar": parent namespace doesn't exist}}

set badVar(0) 1
test tree.379 {myTree export xml -data badVar} {
    list [catch {myTree export xml -data badVar} msg] $msg 
} {1 {can't set "badVar": variable is array}}

test tree.380 {myTree export xml -data myData} {
    list [catch {
...
test tree.381 {myTree export xml -badSwitch} {
    list [catch {myTree export xml -badSwitch} msg] $msg
} {1 {unknown switch "-badSwitch"
The following switches are available:
   -data data
...
test tree.384 {myTree export xml -indent 4} {
...
test tree.390 {tree0 restore 0 -file test.dump} {
    list [catch {
	blt::tree create
...
test tree.402 {tree0 restore 0 {} arg (extra arg)} {
...
test tree.417 {tree0 apply badTag} {
    list [catch {tree0 apply badTag} msg] $msg
} {1 {can't find tag or id "badTag" in ::tree0}}

test tree.418 {tree0 apply all} {
    list [catch {tree0 apply all} msg] $msg
} {1 {tag "all" refers to more than one node}}

test tree.419 {tree0 apply myTag -precommand lappend} {
    list [catch {
	set mylist {}
...
test tree.420 {tree0 apply root -precommand lappend} {
    list [catch {
	set mylist {}
...
test tree.421 {tree0 apply -postcommand} {
    list [catch {
	set mylist {}
...
test tree.422 {tree0 apply -precommand -postcommand} {
    list [catch {
	set mylist {}
	tree0 apply root -precommand {lappend mylist} \
...
test tree.423 {tree0 apply root -precommand lappend -depth 1} {
    list [catch {
	set mylist {}
...
test tree.424 {tree0 apply root -precommand -depth 0} {
    list [catch {
	set mylist {}
...
test tree.425 {tree0 apply root -precommand -tag myTag} {
    list [catch {
	set mylist {}
...
test tree.426 {tree0 apply root -precommand -key key1} {
    list [catch {
	set mylist {}
...
test tree.427 {tree0 apply root -postcommand -regexp node.*} {
    list [catch {
	set mylist {}
	tree0 set myTag key1 0.0
...
test tree.515 {tree0 path (missing arg)} {
    list [catch {tree0 path} msg] $msg
} {1 {wrong # args: should be "tree0 path ?args ...?"}}

test tree.516 {tree0 path badArg} {
...
test tree.517 {tree0 path print root} {
    list [catch {tree0 path print root} msg] $msg
} {0 {}}

test tree.518 {tree0 path print 0} {
    list [catch {tree0 path print 0} msg] $msg
} {0 {}}

test tree.519 {tree0 path print 15} {
    list [catch {tree0 path print 15} msg] $msg
} {0 {node1 node15}}

test tree.520 {tree0 path print 15} {
    list [catch {tree0 path print 15 -separator /} msg] $msg
} {0 /node1/node15}

test tree.521 {tree0 path print 16} {
    list [catch {tree0 path print 16 -separator /} msg] $msg
} {0 /node1/node14/node16}

test tree.522 {tree0 path parse /} {
    list [catch {tree0 path parse / -separator /} msg] $msg
} {0 0}

test tree.523 {tree0 path parse /node1} {
    list [catch {tree0 path parse /node1 -separator /} msg] $msg
} {0 1}

test tree.524 {tree0 path parse /node1/node14} {
    list [catch {tree0 path parse /node1/node14 -separator /} msg] $msg
} {0 14}

test tree.525 {tree0 path parse } {
    list [catch {tree0 path parse /node1/node14/node16 -separator /} msg] $msg
} {0 16}

test tree.526 {tree0 path parse } {
    list [catch {tree0 path parse /node1/node14/node16/ -separator /} msg] $msg
} {0 16}

test tree.527 {tree0 path parse } {
    list [catch {tree0 path parse //node1//node14//node16// -separator /} msg] $msg
} {0 16}

test tree.528 {tree0 path parse } {
    list [catch {tree0 path parse ::node1::node14::node16 -separator ::} msg] $msg
} {0 16}

test tree.529 {tree0 path parse } {
    list [catch {tree0 path parse /node1/node14/node16 -separator /} msg] $msg
} {0 16}

test tree.530 {tree0 path parse } {
    list [catch {tree0 path parse /node1/node14/node16/ -separator /} msg] $msg
} {0 16}

test tree.531 {tree0 path parse } {
    list [catch {tree0 path parse //node1//node14//node16// -separator /} msg] $msg
} {0 16}

test tree.532 {tree0 path parse } {
    list [catch {tree0 path parse ::node1::node14::node16 -separator ::} msg] $msg
} {0 16}

test tree.533 {tree0 path parse ""} {
    list [catch {tree0 path parse {}} msg] $msg
} {0 0}

test tree.534 {tree0 path parse node1 } {
    list [catch {tree0 path parse node1} msg] $msg
} {0 1}

test tree.535 {tree0 path parse {node1 node14}} {
    list [catch {tree0 path parse {node1 node14}} msg] $msg
} {0 14}

test tree.536 {tree0 path parse } {
    list [catch {tree0 path parse {node1 node14 node16}} msg] $msg
} {0 16}


test tree.537 {tree0 path print all} {
    list [catch {tree0 path print all} msg] $msg
} {1 {tag "all" refers to more than one node}}

test tree.538 {tree0 path print 0 badSwitch} {
...
test tree.545 {tree0 tag forget tag1 tag2} {
    list [catch {
...
test tree.546 {tree0 tag forget all} {
    list [catch {
...
test tree.547 {tree0 tag forget root} {
    list [catch {
...
test tree.558 {tree0 move 1 0 -after 2} {
    list [catch {
...
test tree.564 {tree1 attach tree0 -newtags} {
    list [catch {
	blt::tree create
...
test tree.565 {tree1 attach tree0} {
    list [catch {
	blt::tree create
	tree1 attach tree0
	tree1 dump 0 -version 2.0
...
test tree.566 {tree1 attach ""} {
    list [catch {tree1 attach ""} msg] $msg
} {0 {}}


test tree.567 {blt::tree destroy tree1} {
    list [catch {blt::tree destroy tree1} msg] $msg
} {0 {}}

test tree.568 {tree0 find root -badSwitch} {
...
test tree.595 {tree0 sort 0 -decreasing} {
    list [catch {tree0 sort 0 -decreasing} msg] $msg
} {0 {6 5 4 3 2 8}}

test tree.596 {tree0 sort 0} {
    list [catch {
	set list {}
...
test tree.597 {tree0 sort 0 -decreasing} {
    list [catch {tree0 sort 0 -decreasing} msg] $msg
} {0 {6 5 4 3 2 8}}


test tree.598 {tree0 sort 0 -decreasing -key} {
    list [catch {tree0 sort 0 -decreasing -key} msg] $msg
} {1 {value for "-key" missing}}

test tree.599 {tree0 sort 0 -decreasing -key key1} {
    list [catch {tree0 sort 0 -decreasing -key key1} msg] $msg
} {0 {8 6 5 4 3 2}}

test tree.600 {tree0 sort 0 -decreasing -recurse -key key1} {
    list [catch {tree0 sort 0 -decreasing -recurse -key key1} msg] $msg
} {0 {15 16 0 1 2 3 4 5 6 8 13 14 17 18 19 20 21}}

test tree.601 {tree0 sort 0 -decreasing -key key1} {
    list [catch {
	set list {}
...
test tree.628 {test write trace} {
    list [catch {
	set mylist {}
...
test tree.629 {test unset trace} {
    list [catch {
	set mylist {}
	tree0 set all newKey 21
	set mylist
...
test tree.634 {test unset trace} {
    list [catch {
	set mylist {}
...
test tree.643 {test move notify} {
    list [catch {
	set mylist {}
	tree0 move 8 test
	set mylist
...
test tree.644 {test sort notify} {
    list [catch {
	set mylist {}
...
test tree.645 {test relabel notify} {
    list [catch {
	set mylist {}
...
test tree.646 {test delete notify} {
    list [catch {
	set mylist {}
	tree0 delete test
	set mylist
...
test tree.647 {tree0 notify delete badId} {
    list [catch {tree0 notify delete badId} msg] $msg
} {1 {unknown notify name "badId"}}


test tree.648 {test create notify} {
    list [catch {
	set mylist {}
	tree0 set all newKey 20
	set mylist
...
test tree.649 {test delete notify} {
    list [catch {
	set mylist {}
	tree0 unset all newKey
	set mylist
...
test tree.650 {test delete notify} {
    list [catch {
	set mylist {}
	tree0 unset all newKey
	set mylist
...
test tree.660 {tree dir (no recurse flag)} {
    list [catch {
	file delete -force ./testdir
...
test tree.661 {tree dir -recurse} {
    list [catch {
	file delete -force ./testdir
...
test tree.662 {tree dir -recurse} {
    list [catch {
	file delete -force ./testdir
	file mkdir ./testdir
...
test tree.663 {tree dir (default settings, no -recurse)} {
    list [catch {
	file delete -force ./testdir
	file mkdir ./testdir/dir1
	file copy defs ./testdir/dir1
...
test tree.664 {tree dir -type "file pipe"} {
    list [catch {
	set tree [blt::tree create]
...
test tree.665 {tree dir -type link -recurse} {
    list [catch {
	file delete -force ./testdir
	file mkdir ./testdir/dir1
	file copy defs ./testdir/dir1
