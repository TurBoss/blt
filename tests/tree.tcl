...
test tree.143 {tree0 dump 1 -version 2.0} {
...
test tree.144 {tree0 dump this -version 2.0} {
...
test tree.145 {tree0 dump 1 badSwitch} {
...
test tree.246 {tree0 set root myArray(1) 1} {
    list [catch {tree0 set root myArray(1) 1} msg] $msg
} {0 {}}

test tree.247 {tree0 set root myArray(2) 2} {
    list [catch {tree0 set root myArray(2) 2} msg] $msg
} {0 {}}

test tree.248 {tree0 set root myArray(3) 3} {
    list [catch {tree0 set root myArray(3) 3} msg] $msg
} {0 {}}

test tree.249 {tree0 set root myScalar abc} {
    list [catch {tree0 set root myScalar abc} msg] $msg
} {0 {}}

test tree.250 {tree0 unset root myArray(1) myArray(3) myScalar} {
...
test tree.252 {tree0 unset root myArray} {
    list [catch {tree0 unset root myArray} msg] $msg
} {0 {}}

test tree.253 {tree0 get root} {
    list [catch {tree0 get root} msg] $msg
} {0 {key value key1 value1 key2 value2 key3 value3 abc 123}}
...
test tree.267 {myTree lappend root ghi} {
...
test tree.374 {myTree export json -help} {
...
test tree.375 {myTree export json -badSwitch} {
...
test tree.376 {myTree export json -root badNode} {
    list [catch {myTree export json -root badNode} msg] $msg
} {1 {can't find tag or id "badNode" in ::myTree}}

test tree.377 {myTree export json -root (missing arg)} {
    list [catch {myTree export json -root} msg] $msg
} {1 {value for "-root" missing}}

test tree.378 {myTree export json -root 1} {
    list [catch {myTree export json -root 1} msg] $msg
} {0 {{
}
}}

test tree.379 {myTree export json -file (missing arg)} {
    list [catch {myTree export json -file} msg] $msg
} {1 {value for "-file" missing}}

test tree.380 {myTree export json -file badDir/badFile} {
...
test tree.381 {myTree export json -file testDir/noPerms.json} {
    list [catch {
...
test tree.382 {myTree export json -file testDir/myTree.json} {
    list [catch {
...
test tree.387 {myTree export xml -help} {
...
test tree.388 {myTree export xml -badSwitch} {
...
test tree.389 {myTree export xml -root badNode} {
    list [catch {myTree export xml -root badNode} msg] $msg
} {1 {can't find tag or id "badNode" in ::myTree}}

test tree.390 {myTree export xml -root (missing arg)} {
    list [catch {myTree export xml -root} msg] $msg
} {1 {value for "-root" missing}}

test tree.391 {myTree export xml} {
...
test tree.392 {myTree export xml -root 1} {
    list [catch {myTree export xml -root 1} msg] $msg
} {0 {
 <child1></child1>
}}

test tree.393 {myTree export xml -file (missing arg)} {
    list [catch {myTree export xml -file} msg] $msg
} {1 {value for "-file" missing}}

test tree.394 {myTree export xml -file badDir/badFile} {
    list [catch {myTree export xml -file badDir/badFile} msg] $msg
} {1 {couldn't open "badDir/badFile": no such file or directory}}

MakeTestFile noPerms.xml 0500 ""

test tree.395 {myTree export xml -file testDir/noPerms.xml} {
    list [catch {
...
test tree.396 {myTree export xml -file testDir/myTree.xml} {
    list [catch {
...
test tree.397 {myTree export xml -data (missing arg)} {
    list [catch {myTree export xml -data} msg] $msg
} {1 {value for "-data" missing}}

test tree.398 {myTree export xml -data badNs::badVar} {
    list [catch {myTree export xml -data badNs::badVar} msg] $msg
} {1 {can't set "badNs::badVar": parent namespace doesn't exist}}

set badVar(0) 1
test tree.399 {myTree export xml -data badVar} {
    list [catch {myTree export xml -data badVar} msg] $msg 
} {1 {can't set "badVar": variable is array}}

test tree.400 {myTree export xml -data myData} {
    list [catch {
...
test tree.401 {myTree export xml -badSwitch} {
    list [catch {myTree export xml -badSwitch} msg] $msg
} {1 {unknown switch "-badSwitch"
The following switches are available:
   -data data
...
test tree.404 {myTree export xml -indent 4} {
...
test tree.410 {tree0 restore 0 -file test.dump} {
    list [catch {
	blt::tree create
...
test tree.422 {tree0 restore 0 {} arg (extra arg)} {
...
test tree.438 {tree0 apply badTag} {
    list [catch {tree0 apply badTag} msg] $msg
} {1 {can't find tag or id "badTag" in ::tree0}}

test tree.439 {tree0 apply all} {
    list [catch {tree0 apply all} msg] $msg
} {1 {tag "all" refers to more than one node}}

test tree.440 {tree0 apply myTag -precommand lappend} {
    list [catch {
	set mylist {}
...
test tree.441 {tree0 apply root -precommand lappend} {
    list [catch {
	set mylist {}
...
test tree.442 {tree0 apply -postcommand} {
    list [catch {
	set mylist {}
...
test tree.443 {tree0 apply -precommand -postcommand} {
    list [catch {
	set mylist {}
	tree0 apply root -precommand {lappend mylist} \
...
test tree.444 {tree0 apply root -precommand lappend -depth 1} {
    list [catch {
	set mylist {}
...
test tree.445 {tree0 apply root -precommand -depth 0} {
    list [catch {
	set mylist {}
...
test tree.446 {tree0 apply root -precommand -tag myTag} {
    list [catch {
	set mylist {}
...
test tree.447 {tree0 apply root -precommand -key key1} {
    list [catch {
	set mylist {}
...
test tree.448 {tree0 apply root -postcommand -regexp node.*} {
    list [catch {
	set mylist {}
	tree0 set myTag key1 0.0
...
test tree.536 {tree0 path (missing arg)} {
    list [catch {tree0 path} msg] $msg
} {1 {wrong # args: should be "tree0 path ?args ...?"}}

test tree.537 {tree0 path badArg} {
...
test tree.538 {tree0 path print root} {
    list [catch {tree0 path print root} msg] $msg
} {0 {}}

test tree.539 {tree0 path print 0} {
    list [catch {tree0 path print 0} msg] $msg
} {0 {}}

test tree.540 {tree0 path print 15} {
    list [catch {tree0 path print 15} msg] $msg
} {0 {node1 node15}}

test tree.541 {tree0 path print 15} {
    list [catch {tree0 path print 15 -separator /} msg] $msg
} {0 /node1/node15}

test tree.542 {tree0 path print 16} {
    list [catch {tree0 path print 16 -separator /} msg] $msg
} {0 /node1/node14/node16}

test tree.543 {tree0 path parse /} {
    list [catch {tree0 path parse / -separator /} msg] $msg
} {0 0}

test tree.544 {tree0 path parse /node1} {
    list [catch {tree0 path parse /node1 -separator /} msg] $msg
} {0 1}

test tree.545 {tree0 path parse /node1/node14} {
    list [catch {tree0 path parse /node1/node14 -separator /} msg] $msg
} {0 14}

test tree.546 {tree0 path parse } {
    list [catch {tree0 path parse /node1/node14/node16 -separator /} msg] $msg
} {0 16}

test tree.547 {tree0 path parse } {
    list [catch {tree0 path parse /node1/node14/node16/ -separator /} msg] $msg
} {0 16}

test tree.548 {tree0 path parse } {
    list [catch {tree0 path parse //node1//node14//node16// -separator /} msg] $msg
} {0 16}

test tree.549 {tree0 path parse } {
    list [catch {tree0 path parse ::node1::node14::node16 -separator ::} msg] $msg
} {0 16}

test tree.550 {tree0 path parse } {
    list [catch {tree0 path parse /node1/node14/node16 -separator /} msg] $msg
} {0 16}

test tree.551 {tree0 path parse } {
    list [catch {tree0 path parse /node1/node14/node16/ -separator /} msg] $msg
} {0 16}

test tree.552 {tree0 path parse } {
    list [catch {tree0 path parse //node1//node14//node16// -separator /} msg] $msg
} {0 16}

test tree.553 {tree0 path parse } {
    list [catch {tree0 path parse ::node1::node14::node16 -separator ::} msg] $msg
} {0 16}

test tree.554 {tree0 path parse ""} {
    list [catch {tree0 path parse {}} msg] $msg
} {0 0}

test tree.555 {tree0 path parse node1 } {
    list [catch {tree0 path parse node1} msg] $msg
} {0 1}

test tree.556 {tree0 path parse {node1 node14}} {
    list [catch {tree0 path parse {node1 node14}} msg] $msg
} {0 14}

test tree.557 {tree0 path parse } {
    list [catch {tree0 path parse {node1 node14 node16}} msg] $msg
} {0 16}


test tree.558 {tree0 path print all} {
    list [catch {tree0 path print all} msg] $msg
} {1 {tag "all" refers to more than one node}}

test tree.559 {tree0 path print 0 badSwitch} {
...
test tree.566 {tree0 tag forget tag1 tag2} {
    list [catch {
...
test tree.567 {tree0 tag forget all} {
    list [catch {
...
test tree.568 {tree0 tag forget root} {
    list [catch {
...
test tree.579 {tree0 move 1 0 -after 2} {
    list [catch {
...
test tree.586 {tree1 attach tree0 -newtags} {
    list [catch {
	blt::tree create
...
test tree.587 {tree1 attach tree0} {
    list [catch {
	blt::tree create
	tree1 attach tree0
	tree1 dump 0 -version 2.0
...
test tree.588 {tree1 attach ""} {
    list [catch {tree1 attach ""} msg] $msg
} {0 {}}


test tree.589 {blt::tree destroy tree1} {
    list [catch {blt::tree destroy tree1} msg] $msg
} {0 {}}

test tree.590 {tree0 find root -badSwitch} {
...
test tree.617 {tree0 sort 0 -decreasing} {
    list [catch {tree0 sort 0 -decreasing} msg] $msg
} {0 {6 5 4 3 2 8}}

test tree.618 {tree0 sort 0} {
    list [catch {
	set list {}
...
test tree.619 {tree0 sort 0 -decreasing} {
    list [catch {tree0 sort 0 -decreasing} msg] $msg
} {0 {6 5 4 3 2 8}}


test tree.620 {tree0 sort 0 -decreasing -key} {
    list [catch {tree0 sort 0 -decreasing -key} msg] $msg
} {1 {value for "-key" missing}}

test tree.621 {tree0 sort 0 -decreasing -key key1} {
    list [catch {tree0 sort 0 -decreasing -key key1} msg] $msg
} {0 {8 6 5 4 3 2}}

test tree.622 {tree0 sort 0 -decreasing -recurse -key key1} {
    list [catch {tree0 sort 0 -decreasing -recurse -key key1} msg] $msg
} {0 {15 16 0 1 2 3 4 5 6 8 13 14 17 18 19 20 21}}

test tree.623 {tree0 sort 0 -decreasing -key key1} {
    list [catch {
	set list {}
...
test tree.650 {test write trace} {
    list [catch {
	set mylist {}
...
test tree.651 {test unset trace} {
    list [catch {
	set mylist {}
	tree0 set all newKey 21
	set mylist
...
test tree.656 {test unset trace} {
    list [catch {
	set mylist {}
...
test tree.665 {test move notify} {
    list [catch {
	set mylist {}
	tree0 move 8 test
	set mylist
...
test tree.666 {test sort notify} {
    list [catch {
	set mylist {}
...
test tree.667 {test relabel notify} {
    list [catch {
	set mylist {}
...
test tree.668 {test delete notify} {
    list [catch {
	set mylist {}
	tree0 delete test
	set mylist
...
test tree.669 {tree0 notify delete badId} {
    list [catch {tree0 notify delete badId} msg] $msg
} {1 {unknown notify name "badId"}}


test tree.670 {test create notify} {
    list [catch {
	set mylist {}
	tree0 set all newKey 20
	set mylist
...
test tree.671 {test delete notify} {
    list [catch {
	set mylist {}
	tree0 unset all newKey
	set mylist
...
test tree.672 {test delete notify} {
    list [catch {
	set mylist {}
	tree0 unset all newKey
	set mylist
...
test tree.682 {tree dir (no recurse flag)} {
    list [catch {
	file delete -force ./testdir
...
test tree.683 {tree dir -recurse} {
    list [catch {
	file delete -force ./testdir
...
test tree.684 {tree dir -recurse} {
    list [catch {
	file delete -force ./testdir
	file mkdir ./testdir
...
test tree.685 {tree dir (default settings, no -recurse)} {
    list [catch {
	file delete -force ./testdir
	file mkdir ./testdir/dir1
	file copy defs ./testdir/dir1
...
test tree.686 {tree dir -type "file pipe"} {
    list [catch {
	set tree [blt::tree create]
...
test tree.687 {tree dir -type link -recurse} {
    list [catch {
	file delete -force ./testdir
	file mkdir ./testdir/dir1
	file copy defs ./testdir/dir1
