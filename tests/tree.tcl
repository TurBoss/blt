...
test tree.173 {blt::tree create} {
    list [catch {blt::tree create myTree} msg] $msg
} {0 ::myTree}

test tree.174 {myTree set root abc 012} {
    list [catch {myTree set root abc 012} msg] $msg
} {0 {}}

test tree.175 {myTree get root abc} {
    list [catch {myTree get root abc} msg] $msg
} {0 012}

test tree.176 {myTree append root abc 345} {
    list [catch {myTree append root abc 345} msg] $msg
} {0 {}}

test tree.177 {myTree get root abc} {
    list [catch {myTree get root abc} msg] $msg
} {0 012345}

test tree.178 {myTree append root abc (missing arg)} {
    list [catch {myTree append root abc} msg] $msg
} {0 {}}

test tree.179 {myTree append root abc 678 9AB CD EF} {
...
test tree.199 {tree0 restore 0 -file test.dump} {
    list [catch {
	blt::tree create
...
test tree.200 {tree0 unset 0 key1} {
    list [catch {tree0 unset 0 key1} msg] $msg
} {0 {}}

test tree.201 {tree0 get 0} {
    list [catch {tree0 get 0} msg] $msg
} {0 {key value key2 value2 key3 value3 abc 123}}

test tree.202 {tree0 unset 0 key2 key3} {
    list [catch {tree0 unset 0 key2 key3} msg] $msg
} {0 {}}

test tree.203 {tree0 get 0} {
    list [catch {tree0 get 0} msg] $msg
} {0 {key value abc 123}}

test tree.204 {tree0 unset 0} {
    list [catch {tree0 unset 0} msg] $msg
} {0 {}}

test tree.205 {tree0 get 0} {
    list [catch {tree0 get 0} msg] $msg
} {0 {}}

test tree.206 {tree0 unset all abc} {
    list [catch {tree0 unset all abc} msg] $msg
} {0 {}}

test tree.207 {tree0 restore stuff} {
    list [catch {
	set data [tree0 dump root -version 2.0]
...
test tree.210 {tree0 restore 0 {} arg (extra arg)} {
...
test tree.225 {tree0 apply badTag} {
    list [catch {tree0 apply badTag} msg] $msg
} {1 {can't find tag or id "badTag" in ::tree0}}

test tree.226 {tree0 apply all} {
    list [catch {tree0 apply all} msg] $msg
} {1 {tag "all" refers to more than one node.}}

test tree.227 {tree0 apply myTag -precommand lappend} {
    list [catch {
	set mylist {}
...
test tree.228 {tree0 apply root -precommand lappend} {
    list [catch {
	set mylist {}
...
test tree.229 {tree0 apply -postcommand} {
    list [catch {
	set mylist {}
...
test tree.230 {tree0 apply -precommand -postcommand} {
    list [catch {
	set mylist {}
	tree0 apply root -precommand {lappend mylist} \
...
test tree.231 {tree0 apply root -precommand lappend -depth 1} {
    list [catch {
	set mylist {}
...
test tree.232 {tree0 apply root -precommand -depth 0} {
    list [catch {
	set mylist {}
...
test tree.233 {tree0 apply root -precommand -tag myTag} {
    list [catch {
	set mylist {}
...
test tree.234 {tree0 apply root -precommand -key key1} {
    list [catch {
	set mylist {}
...
test tree.235 {tree0 apply root -postcommand -regexp node.*} {
    list [catch {
	set mylist {}
	tree0 set myTag key1 0.0
...
test tree.302 {tree0 path (missing arg)} {
    list [catch {tree0 path} msg] $msg
} {1 {wrong # args: should be "tree0 path ?args ...?"}}

test tree.303 {tree0 path badArg} {
...
test tree.304 {tree0 path print root} {
    list [catch {tree0 path print root} msg] $msg
} {0 {}}

test tree.305 {tree0 path print 0} {
    list [catch {tree0 path print 0} msg] $msg
} {0 {}}

test tree.306 {tree0 path print 15} {
    list [catch {tree0 path print 15} msg] $msg
} {0 {node1 node15}}

test tree.307 {tree0 path print 15} {
    list [catch {tree0 path print 15 -separator /} msg] $msg
} {0 /node1/node15}

test tree.308 {tree0 path print 16} {
    list [catch {tree0 path print 16 -separator /} msg] $msg
} {0 /node1/node14/node16}

test tree.309 {tree0 path parse /} {
    list [catch {tree0 path parse / -separator /} msg] $msg
} {0 0}

test tree.310 {tree0 path parse /node1} {
    list [catch {tree0 path parse /node1 -separator /} msg] $msg
} {0 1}

test tree.311 {tree0 path parse /node1/node14} {
    list [catch {tree0 path parse /node1/node14 -separator /} msg] $msg
} {0 14}

test tree.312 {tree0 path parse } {
    list [catch {tree0 path parse /node1/node14/node16 -separator /} msg] $msg
} {0 16}

test tree.313 {tree0 path parse } {
    list [catch {tree0 path parse /node1/node14/node16/ -separator /} msg] $msg
} {0 16}

test tree.314 {tree0 path parse } {
    list [catch {tree0 path parse //node1//node14//node16// -separator /} msg] $msg
} {0 16}

test tree.315 {tree0 path parse } {
    list [catch {tree0 path parse ::node1::node14::node16 -separator ::} msg] $msg
} {0 16}

test tree.316 {tree0 path parse } {
    list [catch {tree0 path parse /node1/node14/node16 -separator /} msg] $msg
} {0 16}

test tree.317 {tree0 path parse } {
    list [catch {tree0 path parse /node1/node14/node16/ -separator /} msg] $msg
} {0 16}

test tree.318 {tree0 path parse } {
    list [catch {tree0 path parse //node1//node14//node16// -separator /} msg] $msg
} {0 16}

test tree.319 {tree0 path parse } {
    list [catch {tree0 path parse ::node1::node14::node16 -separator ::} msg] $msg
} {0 16}

test tree.320 {tree0 path parse ""} {
    list [catch {tree0 path parse {}} msg] $msg
} {0 0}

test tree.321 {tree0 path parse node1 } {
    list [catch {tree0 path parse node1} msg] $msg
} {0 1}

test tree.322 {tree0 path parse {node1 node14}} {
    list [catch {tree0 path parse {node1 node14}} msg] $msg
} {0 14}

test tree.323 {tree0 path parse } {
    list [catch {tree0 path parse {node1 node14 node16}} msg] $msg
} {0 16}


test tree.324 {tree0 path print all} {
    list [catch {tree0 path print all} msg] $msg
} {1 {tag "all" refers to more than one node.}}

test tree.325 {tree0 path print 0 badSwitch} {
...
test tree.328 {tree0 tag forget hi} {
    list [catch {
	tree0 tag forget hi
	lsort [tree0 tag names]
    } msg] $msg
...
test tree.329 {tree0 tag forget tag1 tag2} {
    list [catch {
...
test tree.330 {tree0 tag forget all} {
    list [catch {
...
test tree.331 {tree0 tag forget root} {
    list [catch {
...
test tree.342 {tree0 move 1 0 -after 2} {
    list [catch {
...
test tree.348 {tree1 attach tree0 -newtags} {
    list [catch {
	blt::tree create
...
test tree.349 {tree1 attach tree0} {
    list [catch {
	blt::tree create
	tree1 attach tree0
	tree1 dump 0 -version 2.0
...
test tree.350 {tree1 attach ""} {
    list [catch {tree1 attach ""} msg] $msg
} {0 {}}


test tree.351 {blt::tree destroy tree1} {
    list [catch {blt::tree destroy tree1} msg] $msg
} {0 {}}

test tree.352 {tree0 find root -badSwitch} {
...
test tree.379 {tree0 sort 0 -decreasing} {
    list [catch {tree0 sort 0 -decreasing} msg] $msg
} {0 {6 5 4 3 2 8}}

test tree.380 {tree0 sort 0} {
    list [catch {
	set list {}
...
test tree.381 {tree0 sort 0 -decreasing} {
    list [catch {tree0 sort 0 -decreasing} msg] $msg
} {0 {6 5 4 3 2 8}}


test tree.382 {tree0 sort 0 -decreasing -key} {
    list [catch {tree0 sort 0 -decreasing -key} msg] $msg
} {1 {value for "-key" missing}}

test tree.383 {tree0 sort 0 -decreasing -key key1} {
    list [catch {tree0 sort 0 -decreasing -key key1} msg] $msg
} {0 {8 6 5 4 3 2}}

test tree.384 {tree0 sort 0 -decreasing -recurse -key key1} {
    list [catch {tree0 sort 0 -decreasing -recurse -key key1} msg] $msg
} {0 {15 16 0 1 2 3 4 5 6 8 13 14 17 18 19 20 21}}

test tree.385 {tree0 sort 0 -decreasing -key key1} {
    list [catch {
	set list {}
...
test tree.407 {test write trace} {
    list [catch {
	set mylist {}
...
test tree.408 {test unset trace} {
    list [catch {
	set mylist {}
	tree0 set all newKey 21
	set mylist
...
test tree.413 {test unset trace} {
    list [catch {
	set mylist {}
...
test tree.422 {test move notify} {
    list [catch {
	set mylist {}
	tree0 move 8 test
	set mylist
...
test tree.423 {test sort notify} {
    list [catch {
	set mylist {}
...
test tree.424 {test relabel notify} {
    list [catch {
	set mylist {}
...
test tree.425 {test delete notify} {
    list [catch {
	set mylist {}
	tree0 delete test
	set mylist
...
test tree.426 {tree0 notify delete badId} {
    list [catch {tree0 notify delete badId} msg] $msg
} {1 {unknown notify name "badId"}}


test tree.427 {test create notify} {
    list [catch {
	set mylist {}
	tree0 set all newKey 20
	set mylist
...
test tree.428 {test delete notify} {
    list [catch {
	set mylist {}
	tree0 unset all newKey
	set mylist
...
test tree.429 {test delete notify} {
    list [catch {
	set mylist {}
	tree0 unset all newKey
	set mylist
...
test tree.437 {tree dir (no recurse flag)} {
    list [catch {
...
test tree.438 {tree dir -recurse} {
    list [catch {
	file delete -force ./testdir
...
test tree.439 {tree dir -recurse} {
    list [catch {
	file delete -force ./testdir
	file mkdir ./testdir
...
test tree.440 {tree dir (default settings, no -recurse)} {
    list [catch {
	file delete -force ./testdir
	file mkdir ./testdir/dir1
	file copy defs ./testdir/dir1
...
test tree.441 {tree dir -type "file pipe"} {
    list [catch {
	set tree [blt::tree create]
...
test tree.442 {tree dir -type link -recurse} {
    list [catch {
	file delete -force ./testdir
	file mkdir ./testdir/dir1
	file copy defs ./testdir/dir1
