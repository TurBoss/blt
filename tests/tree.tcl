...
test tree.111 {tree0 dump 1 -version 2.0} {
...
test tree.112 {tree0 dump this -version 2.0} {
...
test tree.113 {tree0 dump 1 badSwitch} {
...
test tree.298 {myTree export} {
    list [catch {myTree export} msg] $msg
} {0 {}}

test tree.299 {myTree import} {
    list [catch {myTree import} msg] $msg
} {0 {}}

test tree.300 {package require blt_tree_xml} {
    list [catch {package require blt_tree_xml} msg] $msg
} {0 3.0}

test tree.301 {myTree export} {
    list [catch {myTree export} msg] $msg
} {0 xml}

test tree.302 {myTree import} {
    list [catch {myTree import} msg] $msg
} {0 xml}

test tree.303 {package require blt_tree_json} {
    list [catch {package require blt_tree_json} msg] $msg
} {0 3.0}

test tree.304 {myTree export} {
    list [catch {myTree export} msg] $msg
} {0 {xml json}}
...
test tree.309 {myTree export json -help} {
...
test tree.310 {myTree export json -badSwitch} {
...
test tree.311 {myTree export json -root badNode} {
    list [catch {myTree export json -root badNode} msg] $msg
} {1 {can't find tag or id "badNode" in ::myTree}}

test tree.312 {myTree export json -root (missing arg)} {
    list [catch {myTree export json -root} msg] $msg
} {1 {value for "-root" missing}}

test tree.313 {myTree export json -root 1} {
    list [catch {myTree export json -root 1} msg] $msg
} {0 {{
}
}}

test tree.314 {myTree export json -file (missing arg)} {
    list [catch {myTree export json -file} msg] $msg
} {1 {value for "-file" missing}}

test tree.315 {myTree export json -file badDir/badFile} {
...
test tree.316 {myTree export json -file testDir/noPerms.json} {
    list [catch {
...
test tree.317 {myTree export json -file testDir/myTree.json} {
    list [catch {
...
test tree.322 {myTree export xml -help} {
...
test tree.323 {myTree export xml -badSwitch} {
...
test tree.324 {myTree export xml -root badNode} {
    list [catch {myTree export xml -root badNode} msg] $msg
} {1 {can't find tag or id "badNode" in ::myTree}}

test tree.325 {myTree export xml -root (missing arg)} {
    list [catch {myTree export xml -root} msg] $msg
} {1 {value for "-root" missing}}

test tree.326 {myTree export xml} {
...
test tree.327 {myTree export xml -root 1} {
    list [catch {myTree export xml -root 1} msg] $msg
} {0 {
 <child1></child1>
}}

test tree.328 {myTree export xml -file (missing arg)} {
    list [catch {myTree export xml -file} msg] $msg
} {1 {value for "-file" missing}}

test tree.329 {myTree export xml -file badDir/badFile} {
    list [catch {myTree export xml -file badDir/badFile} msg] $msg
} {1 {couldn't open "badDir/badFile": no such file or directory}}

MakeTestFile noPerms.xml 0500 ""

test tree.330 {myTree export xml -file testDir/noPerms.xml} {
    list [catch {
...
test tree.331 {myTree export xml -file testDir/myTree.xml} {
    list [catch {
...
test tree.332 {myTree export xml -data (missing arg)} {
    list [catch {myTree export xml -data} msg] $msg
} {1 {value for "-data" missing}}

test tree.333 {myTree export xml -data badNs::badVar} {
    list [catch {myTree export xml -data badNs::badVar} msg] $msg
} {1 {can't set "badNs::badVar": parent namespace doesn't exist}}

set badVar(0) 1
test tree.334 {myTree export xml -data badVar} {
    list [catch {myTree export xml -data badVar} msg] $msg 
} {1 {can't set "badVar": variable is array}}

test tree.335 {myTree export xml -data myData} {
    list [catch {
...
test tree.336 {myTree export xml -badSwitch} {
    list [catch {myTree export xml -badSwitch} msg] $msg
} {1 {unknown switch "-badSwitch"
The following switches are available:
   -data data
...
test tree.339 {myTree export xml -indent 4} {
...
test tree.341 {tree0 restore stuff} {
    list [catch {
...
test tree.342 {tree0 restore 0 -file test.dump} {
    list [catch {
	blt::tree create
...
test tree.354 {tree0 restore 0 {} arg (extra arg)} {
...
test tree.369 {tree0 apply badTag} {
    list [catch {tree0 apply badTag} msg] $msg
} {1 {can't find tag or id "badTag" in ::tree0}}

test tree.370 {tree0 apply all} {
    list [catch {tree0 apply all} msg] $msg
} {1 {tag "all" refers to more than one node}}

test tree.371 {tree0 apply myTag -precommand lappend} {
    list [catch {
	set mylist {}
...
test tree.372 {tree0 apply root -precommand lappend} {
    list [catch {
	set mylist {}
...
test tree.373 {tree0 apply -postcommand} {
    list [catch {
	set mylist {}
...
test tree.374 {tree0 apply -precommand -postcommand} {
    list [catch {
	set mylist {}
	tree0 apply root -precommand {lappend mylist} \
...
test tree.375 {tree0 apply root -precommand lappend -depth 1} {
    list [catch {
	set mylist {}
...
test tree.376 {tree0 apply root -precommand -depth 0} {
    list [catch {
	set mylist {}
...
test tree.377 {tree0 apply root -precommand -tag myTag} {
    list [catch {
	set mylist {}
...
test tree.378 {tree0 apply root -precommand -key key1} {
    list [catch {
	set mylist {}
...
test tree.379 {tree0 apply root -postcommand -regexp node.*} {
    list [catch {
	set mylist {}
	tree0 set myTag key1 0.0
...
test tree.446 {tree0 path (missing arg)} {
    list [catch {tree0 path} msg] $msg
} {1 {wrong # args: should be "tree0 path ?args ...?"}}

test tree.447 {tree0 path badArg} {
...
test tree.448 {tree0 path print root} {
    list [catch {tree0 path print root} msg] $msg
} {0 {}}

test tree.449 {tree0 path print 0} {
    list [catch {tree0 path print 0} msg] $msg
} {0 {}}

test tree.450 {tree0 path print 15} {
    list [catch {tree0 path print 15} msg] $msg
} {0 {node1 node15}}

test tree.451 {tree0 path print 15} {
    list [catch {tree0 path print 15 -separator /} msg] $msg
} {0 /node1/node15}

test tree.452 {tree0 path print 16} {
    list [catch {tree0 path print 16 -separator /} msg] $msg
} {0 /node1/node14/node16}

test tree.453 {tree0 path parse /} {
    list [catch {tree0 path parse / -separator /} msg] $msg
} {0 0}

test tree.454 {tree0 path parse /node1} {
    list [catch {tree0 path parse /node1 -separator /} msg] $msg
} {0 1}

test tree.455 {tree0 path parse /node1/node14} {
    list [catch {tree0 path parse /node1/node14 -separator /} msg] $msg
} {0 14}

test tree.456 {tree0 path parse } {
    list [catch {tree0 path parse /node1/node14/node16 -separator /} msg] $msg
} {0 16}

test tree.457 {tree0 path parse } {
    list [catch {tree0 path parse /node1/node14/node16/ -separator /} msg] $msg
} {0 16}

test tree.458 {tree0 path parse } {
    list [catch {tree0 path parse //node1//node14//node16// -separator /} msg] $msg
} {0 16}

test tree.459 {tree0 path parse } {
    list [catch {tree0 path parse ::node1::node14::node16 -separator ::} msg] $msg
} {0 16}

test tree.460 {tree0 path parse } {
    list [catch {tree0 path parse /node1/node14/node16 -separator /} msg] $msg
} {0 16}

test tree.461 {tree0 path parse } {
    list [catch {tree0 path parse /node1/node14/node16/ -separator /} msg] $msg
} {0 16}

test tree.462 {tree0 path parse } {
    list [catch {tree0 path parse //node1//node14//node16// -separator /} msg] $msg
} {0 16}

test tree.463 {tree0 path parse } {
    list [catch {tree0 path parse ::node1::node14::node16 -separator ::} msg] $msg
} {0 16}

test tree.464 {tree0 path parse ""} {
    list [catch {tree0 path parse {}} msg] $msg
} {0 0}

test tree.465 {tree0 path parse node1 } {
    list [catch {tree0 path parse node1} msg] $msg
} {0 1}

test tree.466 {tree0 path parse {node1 node14}} {
    list [catch {tree0 path parse {node1 node14}} msg] $msg
} {0 14}

test tree.467 {tree0 path parse } {
    list [catch {tree0 path parse {node1 node14 node16}} msg] $msg
} {0 16}


test tree.468 {tree0 path print all} {
    list [catch {tree0 path print all} msg] $msg
} {1 {tag "all" refers to more than one node}}

test tree.469 {tree0 path print 0 badSwitch} {
...
test tree.472 {tree0 tag forget hi} {
    list [catch {
	tree0 tag forget hi
	lsort [tree0 tag names]
    } msg] $msg
...
test tree.473 {tree0 tag forget tag1 tag2} {
    list [catch {
...
test tree.474 {tree0 tag forget all} {
    list [catch {
...
test tree.475 {tree0 tag forget root} {
    list [catch {
...
test tree.486 {tree0 move 1 0 -after 2} {
    list [catch {
...
test tree.492 {tree1 attach tree0 -newtags} {
    list [catch {
	blt::tree create
...
test tree.493 {tree1 attach tree0} {
    list [catch {
	blt::tree create
	tree1 attach tree0
	tree1 dump 0 -version 2.0
...
test tree.494 {tree1 attach ""} {
    list [catch {tree1 attach ""} msg] $msg
} {0 {}}


test tree.495 {blt::tree destroy tree1} {
    list [catch {blt::tree destroy tree1} msg] $msg
} {0 {}}

test tree.496 {tree0 find root -badSwitch} {
...
test tree.497 {tree0 find root -order} {
...
test tree.523 {tree0 sort 0 -decreasing} {
    list [catch {tree0 sort 0 -decreasing} msg] $msg
} {0 {6 5 4 3 2 8}}

test tree.524 {tree0 sort 0} {
    list [catch {
	set list {}
...
test tree.525 {tree0 sort 0 -decreasing} {
    list [catch {tree0 sort 0 -decreasing} msg] $msg
} {0 {6 5 4 3 2 8}}


test tree.526 {tree0 sort 0 -decreasing -key} {
    list [catch {tree0 sort 0 -decreasing -key} msg] $msg
} {1 {value for "-key" missing}}

test tree.527 {tree0 sort 0 -decreasing -key key1} {
    list [catch {tree0 sort 0 -decreasing -key key1} msg] $msg
} {0 {8 6 5 4 3 2}}

test tree.528 {tree0 sort 0 -decreasing -recurse -key key1} {
    list [catch {tree0 sort 0 -decreasing -recurse -key key1} msg] $msg
} {0 {15 16 0 1 2 3 4 5 6 8 13 14 17 18 19 20 21}}

test tree.529 {tree0 sort 0 -decreasing -key key1} {
    list [catch {
	set list {}
...
test tree.551 {test write trace} {
    list [catch {
	set mylist {}
...
test tree.552 {test unset trace} {
    list [catch {
	set mylist {}
	tree0 set all newKey 21
	set mylist
...
test tree.557 {test unset trace} {
    list [catch {
	set mylist {}
...
test tree.566 {test move notify} {
    list [catch {
	set mylist {}
	tree0 move 8 test
	set mylist
...
test tree.567 {test sort notify} {
    list [catch {
	set mylist {}
...
test tree.568 {test relabel notify} {
    list [catch {
	set mylist {}
...
test tree.569 {test delete notify} {
    list [catch {
	set mylist {}
	tree0 delete test
	set mylist
...
test tree.570 {tree0 notify delete badId} {
    list [catch {tree0 notify delete badId} msg] $msg
} {1 {unknown notify name "badId"}}


test tree.571 {test create notify} {
    list [catch {
	set mylist {}
	tree0 set all newKey 20
	set mylist
...
test tree.572 {test delete notify} {
    list [catch {
	set mylist {}
	tree0 unset all newKey
	set mylist
...
test tree.573 {test delete notify} {
    list [catch {
	set mylist {}
	tree0 unset all newKey
	set mylist
...
test tree.581 {tree dir (no recurse flag)} {
    list [catch {
	file delete -force ./testdir
...
test tree.582 {tree dir -recurse} {
    list [catch {
	file delete -force ./testdir
...
test tree.583 {tree dir -recurse} {
    list [catch {
	file delete -force ./testdir
	file mkdir ./testdir
...
test tree.584 {tree dir (default settings, no -recurse)} {
    list [catch {
	file delete -force ./testdir
	file mkdir ./testdir/dir1
	file copy defs ./testdir/dir1
...
test tree.585 {tree dir -type "file pipe"} {
    list [catch {
	set tree [blt::tree create]
...
test tree.586 {tree dir -type link -recurse} {
    list [catch {
	file delete -force ./testdir
	file mkdir ./testdir/dir1
	file copy defs ./testdir/dir1
