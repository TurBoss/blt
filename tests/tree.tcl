...
test tree.637 {tree8 search -badSwitch} {
...
test tree.647 {tree8 search -variable } {
    list [catch {tree8 search -variable} msg] $msg
} {1 {value for "-variable" missing}}

test tree.648 {tree8 search -variable badVar} {
...
test tree.656 {tree8 search -tag newTag} {
  list [catch {
    tree8 search -tag newTag
  } msg] $msg
} {0 {1 2 3 4 13 5 6 8 0}}

test tree.656 {tree8 search -tag newTag -invert} {
  list [catch {
    tree8 search -tag newTag -invert
  } msg] $msg
} {0 {20 18 16 14 21 19 17 15}}

test tree.656 {tree8 search -tag {new* glob}} {
  list [catch {
    tree8 search -tag {new* glob}
  } msg] $msg
} {0 {1 2 3 4 13 5 6 8 0}}

test tree.656 {tree8 search -tag {*tag glob nocase}} {
  list [catch {
    tree8 search -tag {*tag glob nocase}
  } msg] $msg
} {0 {1 2 3 4 13 5 6 8 0}}

test tree.656 {tree8 search -tag thisTag -tag myTag} {
  list [catch {
    tree8 search -tag thisTag -tag myTag
  } msg] $msg
} {0 {5 8}}

test tree.656 {tree8 search -tag {tag* glob}} {
  list [catch {
    tree8 search -tag {tag* glob}
  } msg] $msg
} {0 {1 2 3 4 0}}

test tree.656 {tree8 search -tag thisTag} {
  list [catch {
